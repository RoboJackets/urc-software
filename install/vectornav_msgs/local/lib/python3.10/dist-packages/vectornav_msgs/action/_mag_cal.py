...
class MagCal_Result(metaclass=Metaclass_MagCal_Result):
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if any(self.avg_dev != other.avg_dev):
            return False
        if any(self.calib != other.calib):
            return False
        return True
...
class MagCal_Feedback(metaclass=Metaclass_MagCal_Feedback):
    ...
    def __init__(self, **kwargs):
        ...
        if 'curr_avg_dev' not in kwargs:
            ...
            self.curr_avg_dev = kwargs.get('curr_avg_dev')
        if 'curr_calib' not in kwargs:
            self.curr_calib = numpy.zeros(12, dtype=numpy.float32)
        else:
            self.curr_calib = kwargs.get('curr_calib')
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if any(self.curr_avg_dev != other.curr_avg_dev):
            return False
        if any(self.curr_calib != other.curr_calib):
            return False

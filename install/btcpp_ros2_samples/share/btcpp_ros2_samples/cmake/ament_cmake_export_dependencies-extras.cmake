...
# variables to btcpp_ros2_samples_DEFINITIONS, btcpp_ros2_samples_INCLUDE_DIRS,
# btcpp_ros2_samples_LIBRARIES, and btcpp_ros2_samples_LINK_FLAGS.
# Additionally collect the direct dependency names in
# btcpp_ros2_samples_DEPENDENCIES as well as the recursive dependency names
# in btcpp_ros2_samples_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(btcpp_ros2_samples_DEPENDENCIES ${_exported_dependencies})
  set(btcpp_ros2_samples_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(btcpp_ros2_samples_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(btcpp_ros2_samples_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(btcpp_ros2_samples_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(btcpp_ros2_samples_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(btcpp_ros2_samples_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND btcpp_ros2_samples_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()

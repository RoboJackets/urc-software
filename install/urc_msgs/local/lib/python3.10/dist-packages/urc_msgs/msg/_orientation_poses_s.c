...
bool urc_msgs__msg__orientation_poses__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("urc_msgs.msg._orientation_poses.OrientationPoses", full_classname_dest, 48) == 0);
  }
  urc_msgs__msg__OrientationPoses * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of OrientationPoses */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("urc_msgs.msg._orientation_poses");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OrientationPoses");

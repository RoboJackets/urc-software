...
namespace chassis_controller
{
  ...
  ChassisController::ChassisController(const rclcpp::NodeOptions &options)
      : rclcpp::Node("chassis_controller", options)
  {
    ...
    timer_ = this->create_wall_timer(
        ...
        std::bind(&ChassisController::publishEncoderTicks, this));
        [&]() { &ChassisController::publishEncoderTicks(this) };
  }

  void ChassisController::publishEncoderTicks()
  {
  ...
  ChassisController::ChassisControllerDriver::ChassisControllerDriver(std::string ip_addr_server, int port)
  {
  ...
  bool ChassisController:ChassisControllerDriver::getEncoderTicks(DriveEncodersMessage &message)
  {
    size_t bytes_read;
    ...
    return pb_decode(&istream, DriveEncodersMessage_fields, &message);
  }

  int ChassisController::ChassisControllerDriver::getPortNumber()
  {
    return this->port_;
  }
...
RCLCPP_COMPONENTS_REGISTER_NODE(chassis_controller::ChassisController)

...
: ${AMENT_CURRENT_PREFIX:="/home/robojackets/urc_ws/colcon-urc/src/urc-software/install/urc_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/urc_gazebo/environment/library_path.sh"

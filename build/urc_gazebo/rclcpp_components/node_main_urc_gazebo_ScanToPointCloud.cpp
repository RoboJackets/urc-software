...
#define NODE_MAIN_LOGGER_NAME "urc_gazebo_ScanToPointCloud"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liburc_gazebo.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<scan_to_pointcloud::ScanToPointCloud>";

  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: A }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : L(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === U && i(V, t) && !i(B, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== U || !i(V, n) || i(B, n))) {
          var r = I(t, n);
          return !r || !i(V, n) || (i(t, D) && t[D][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = N(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(U, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(B, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), $(this, t, E(1, r));
            };
    ...
    (i = window.Core.PDFNet),
                  ...
                  function(r) {
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          return (r.next = 2), i.FDFDoc.createFromXFDF(n);
                        case 2:
                          return (o = r.sent), (r.next = 5), t.getPageIterator();
                        case 5:
                          u = r.sent;
                        case 6:
                          return (r.next = 8), u.hasNext();
                        case 8:
                          if (!r.sent) {
                            r.next = 41;
                            break;
                          }
                          return (r.prev = 9), (r.next = 12), u.current();
                        case 12:
                          return (c = r.sent), (r.next = 15), c.getNumAnnots();
                        case 15:
                          f = r.sent;
                        case 16:
                          if (!(f > 0)) {
                          ...
                          return (r.next = 19), c.getAnnot(--f);
                        case 19:
                          return (a = r.sent), (r.next = 22), a.getType();
                        case 22:
                          (r.t0 = r.sent),
                            (r.next =
                              r.t0 === i.Annot.Type.e_Widget || r.t0 === i.Annot.Type.e_Link || r.t0 === i.Annot.Type.e_Sound || r.t0 === i.Annot.Type.e_Movie || r.t0 === i.Annot.Type.e_FileAttachment
                                ? 25
                                : 26);
                          break;
                        case 25:
                        ...
                        case 26:
                          return c.annotRemoveByIndex(f), r.abrupt('break', 28);
                        case 28:
                          r.next = 16;
                          break;
                        case 30:
                          ...
                          break;
                        case 32:
                          return (r.prev = 32), (r.t1 = r.catch(9)), console.log('Error Removing Annotations: ' + r.t1), (r.next = 37), c.getSDFObj();
                        case 37:
                          r.sent.erase('Annots');
                        case 38:
                          u.next(), (r.next = 6);
                        ...
                        case 45:
                          return (r.next = 47), t.saveMemoryBuffer(i.SDFDoc.SaveOptions.e_linearized);
                        case 47:
      ...
      (c = function(t) {
        ...
        return i
          ...
          .then(function(n) {
            return u(n, t.xfdfString);
          })
          .then(function(t) {
            return r.deleteAnnotations(e), n.refreshAll(), n.updateView(), n.getDocument().refreshTextData(), t;
          });
      }),
      window.addEventListener('documentLoaded', function() {
        instance.Core.documentViewer.getDocument().getFileData = c;
      });
  },
]);

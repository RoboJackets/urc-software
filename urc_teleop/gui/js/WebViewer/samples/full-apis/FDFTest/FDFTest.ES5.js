!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Bt, Ct),
        p(Bt, yt, Ct.values),
        v(Bt, { slice: kt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        At(Bt, 'buffer', 'b'),
        At(Bt, 'byteOffset', 'o'),
        At(Bt, 'byteLength', 'l'),
        At(Bt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ft(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(j) instanceof n && 0 !== O.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      L = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = F(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : L(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            var M = b.groups;
            if (p) {
              var j = [E].concat(O, F, h);
              void 0 !== M && j.push(M);
              var A = String(n.apply(void 0, j));
            } else A = y(E, h, F, O, M, n);
            F >= w && ((S += h.slice(w, F) + A), (w = F + E.length));
          }
          return S + h.slice(w);
        },
      ];
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return console.log('Beginning FDF Test.'), (o = '../TestFiles/'), (t.prev = 2), console.log('Import annotations from XFDF to FDF.'), (t.next = 6), r(o + 'form1_annots.xfdf');
                        case 6:
                          return (i = t.sent), (t.next = 9), n.PDFDoc.createFromURL(o + 'form1.pdf');
                        case 9:
                          return (u = t.sent).initSecurityHandler(), console.log('Update annotations from fdf'), u.fdfUpdate(i), (t.next = 15), u.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 15:
                          (c = t.sent), saveBufferAsPDFDoc(c, 'form1_with_annots.pdf'), console.log('Done sample'), (t.next = 23);
                          break;
                        case 20:
                          (t.prev = 20), (t.t0 = t.catch(2)), console.log(t.t0);
                        case 23:
                          return (t.prev = 23), console.log('Extract annotations from PDF.'), (t.next = 27), n.PDFDoc.createFromURL(''.concat(o, 'form1.pdf'));
                        case 27:
                          return (f = t.sent).initSecurityHandler(), (t.next = 31), f.fdfExtract(n.PDFDoc.ExtractFlag.e_both);
                        case 31:
                          return (a = t.sent), (t.next = 34), a.saveAsXFDFAsString();
                        case 34:
                          (s = t.sent), console.log('XFDF extracted from form1.pdf'), console.log(s), console.log('Done sample'), (t.next = 43);
                          break;
                        case 40:
                          (t.prev = 40), (t.t1 = t.catch(23)), console.log(t.t1);
                        case 43:
                          return (t.prev = 43), console.log('Extract existing fields from PDF.'), (t.next = 47), n.PDFDoc.createFromURL(''.concat(o, 'form1.pdf'));
                        case 47:
                          return (l = t.sent).initSecurityHandler(), (t.next = 51), l.getFieldIteratorBegin();
                        case 51:
                          h = t.sent;
                        case 52:
                          return (t.next = 54), h.hasNext();
                        case 54:
                          if (!t.sent) {
                            t.next = 66;
                            break;
                          }
                          return (t.next = 57), h.current();
                        case 57:
                          return (p = t.sent), (t.t2 = console), (t.next = 61), p.getName();
                        case 61:

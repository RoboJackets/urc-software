!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = w(r)) || 'SharedArrayBuffer' == f)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
                  ...
                  return e().wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 5:
                          return (o = t.sent).initSecurityHandler(), o.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 11), n.PDFDraw.create(92);
                        case 11:
                          return (i = t.sent), (t.next = 14), o.getPageIterator(1);
                        case 14:
                          return (u = t.sent), (t.next = 17), u.current();
                        case 17:
                          return (c = t.sent), (t.next = 20), i.exportStream(c, 'PNG');
                        case 20:
                          return (f = t.sent), saveBufferAsPNG(f, 'newsletter.png'), (t.next = 24), i.exportStream(c, 'TIFF');
                        case 24:
                          return (a = t.sent), saveBufferAsPNG(a, 'newsletter.tif'), console.log('Done'), t.abrupt('return', r);
                        case 28:
                        case 'end':
                          return t.stop();
                      }

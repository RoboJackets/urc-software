!(function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
                ...
                return e().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 6:
                        (u = t.sent), (t.t0 = u), (t.next = t.t0 === n.Element.Type.e_path ? 10 : t.t0 === n.Element.Type.e_text ? 16 : t.t0 === n.Element.Type.e_form ? 21 : 26);
                        break;
                      case 10:
                        return (t.next = 12), i.getPathData();
                      case 12:
                        return (c = t.sent), c.operators, c.points, t.abrupt('break', 26);
                      case 16:
                        return (t.next = 18), i.getTextString();
                      case 18:
                        return (a = t.sent), console.log(a), t.abrupt('break', 26);
                      case 21:
                        return o.formBegin(), (t.next = 24), r(o);
                      case 24:
                        return o.end(), t.abrupt('break', 26);
                      case 26:
                        return (t.next = 28), o.next();
                      case 28:
                        (i = t.sent), (t.next = 3);
                        break;
                      case 31:
                ...
                return e().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 7:
                        return (i = t.sent).initSecurityHandler(), i.lock(), (t.next = 12), i.getPageCount();
                      case 12:
                        return t.sent, (t.next = 15), n.ElementReader.create();
                      case 15:
                        return (u = t.sent), (t.next = 18), i.getPageIterator(1);
                      case 18:
                        c = t.sent;
                      case 20:
                        return (t.next = 22), c.hasNext();
                      case 22:
                        if (!t.sent) {
                          t.next = 33;
                          break;
                        }
                        return (t.next = 25), c.current();
                      case 25:
                        return (a = t.sent), u.beginOnPage(a), (t.next = 29), r(u);
                      case 29:
                        u.end();
                      case 30:
                        c.next(), (t.next = 20);
                        break;
                      case 33:
                        return console.log('Done.'), t.abrupt('return', o);
                      case 35:
                      case 'end':
                        return t.stop();
                    }

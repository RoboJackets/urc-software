    ...
    if (r(8)) {
      var o = r(30),
        ...
        kt = {
          ...
          filter: function(t) {
            return jt(this, J(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || L(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : L(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === U && i(B, t) && !i(V, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== U || !i(B, n) || i(V, n))) {
          var r = I(t, n);
          return !r || !i(B, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = N(r ? V : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(U, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(V, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), H(this, t, E(1, r));
            };
                        ...
                        onClick: function(n) {
                          n('disabled'),
                            (function(t) {
                              ...
                              n = (function() {
                                var t = i(
                                  e().mark(function t(r, o, i) {
                                    var c, a, f, s, l, h, p, v, y, d;
                                    return e().wrap(function(t) {
                                      for (;;)
                                        switch ((t.prev = t.next)) {
                                          case 0:
                                            return (t.next = 2), u.startDeallocateStack();
                                          case 2:
                                            return console.log('Processing elements'), (t.next = 5), u.ColorSpace.createDeviceRGB();
                                          case 5:
                                            return (f = t.sent), (t.next = 8), u.ColorPt.init(1, 0, 0, 0);
                                          case 8:
                                            return (s = t.sent), (t.next = 11), u.ColorPt.init(0, 0, 1, 0);
                                          case 11:
                                            return (l = t.sent), (t.next = 14), r.next();
                                          case 14:
                                            c = t.sent;
                                          case 15:
                                            if (null === c) {
                                          ...
                                          case 18:
                                            (h = t.sent),
                                              ...
                                              (t.t0 = h),
                                              (t.next =
                                                t.t0 === u.Element.Type.e_image || t.t0 === u.Element.Type.e_inline_image
                                                  ? 26
                                                  : t.t0 === u.Element.Type.e_path
                                                  ? 27
                                                  : t.t0 === u.Element.Type.e_text
                                                  ? 35
                                                  : t.t0 === u.Element.Type.e_form
                                                  ? 43
                                                  : 65);
                                            break;
                                          case 26:
                                          ...
                                          case 27:
                                            return (t.next = 29), c.getGState();
                                          case 29:
                                            return (a = t.sent).setFillColorSpace(f), a.setFillColorWithColorPt(s), (t.next = 34), o.writeElement(c);
                                          case 34:
                                            return t.abrupt('break', 67);
                                          case 35:
                                            return (t.next = 37), c.getGState();
                                          case 37:
                                            return (a = t.sent).setFillColorSpace(f), a.setFillColorWithColorPt(l), (t.next = 42), o.writeElement(c);
                                          case 42:
                                            return t.abrupt('break', 67);
                                          case 43:
                                            return (t.next = 45), o.writeElement(c);
                                          case 45:
                                            return (t.next = 47), c.getXObject();
                                          case 47:
                                            if (((p = t.sent), (v = p.getObjNum()), -1 !== i.indexOf(v))) {
                                              t.next = 64;
                                              break;
                                            }
                                            return (t.next = 52), p.getObjNum();
                                          case 52:
                                            return (y = t.sent), i.includes(y) || i.push(y), (t.next = 56), u.ElementWriter.create();
                                          case 56:
                                            return (d = t.sent), r.formBegin(), d.beginOnObj(p, !0), (t.next = 61), n(r, d, i);
                                          case 61:
                                            d.end(), r.end(), d && d.destroy();
                                          case 64:
                                            return t.abrupt('break', 67);
                                          case 65:
                                            return (t.next = 67), o.writeElement(c);
                                          case 67:
                                          ...
                                          case 69:
                                            ...
                                            break;
                                          case 72:
                                            return (t.next = 74), u.endDeallocateStack();
                                          case 74:
                                          case 'end':
                                            return t.stop();
                                        }
                              ...
                              var r = (function() {
                                var r = i(
                                  e().mark(function r() {
                                    var o, i, c, a, f, s, l, h, p, v;
                                    return e().wrap(
                                      function(r) {
                                        for (;;)
                                          switch ((r.prev = r.next)) {
                                            case 0:
                                              return (o = 0), (r.prev = 1), (i = t).lock(), i.initSecurityHandler(), (r.next = 7), u.ElementWriter.create();
                                            case 7:
                                              return (c = r.sent), (r.next = 10), u.ElementReader.create();
                                            case 10:
                                              return (a = r.sent), (f = []), (r.next = 14), i.getPageCount();
                                            case 14:
                                              (s = r.sent), (l = 1);
                                            case 16:
                                              if (!(l <= s)) {
                                              ...
                                              return i.unlock(), (r.next = 20), u.finishOperation();
                                            case 20:
                                              return (r.next = 22), i.requirePage(l);
                                            case 22:
                                              return (r.next = 24), u.beginOperation();
                                            case 24:
                                              return i.lock(), (r.next = 27), i.getPage(l);
                                            case 27:
                                              return (h = r.sent), (r.next = 30), h.getSDFObj();
                                            case 30:
                                              return (p = r.sent), (r.next = 33), p.getObjNum();
                                            case 33:
                                              return (
                                                (v = r.sent), f.includes(v) || f.push(v), a.beginOnPage(h), c.beginOnPage(h, u.ElementWriter.WriteMode.e_replacement, !1), (r.next = 39), n(a, c, f)
                                              );
                                            case 39:
                                              c.end(),
                                                a.end(),
                                                console.log('page ' + l + ' finished editing'),
                                                instance.Core.documentViewer.refreshPage(l),
                                                instance.Core.documentViewer.updateView([l]),
                                                l++,
                                                (r.next = 16);
                                              break;
                                            case 47:
                                              ...
                                              break;
                                            case 50:
                                              (r.prev = 50), (r.t0 = r.catch(1)), console.log(r.t0.stack), (o = 1);
                                            case 54:
                              ...
                              return u.runWithCleanup(r);
                            })(t).then(function() {
                              n('enabled');
                            });
                        },
                      },
                      disabled: { img: c('lightgray'), onClick: function() {}, className: 'disabled' },
                    },
                    mount: function() {},
                  }),
                  n

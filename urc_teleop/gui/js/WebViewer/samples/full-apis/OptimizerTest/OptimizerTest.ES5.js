  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Gt = function(t, n) {
          return Wt(t, (n = b(n, !0))) ? h(2, t[n]) : z(t, n);
        },
        Bt = function(t, n, r) {
      ...
      v(Ut, Ct),
        p(Ut, yt, Ct.values),
        v(Ut, { slice: Rt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                if (w(r)) {
                  ...
                  } else if ((u = d(o) * n) + h > y) throw V('Wrong length!');
                  c = u / n;
    ...
    var o = r(1),
      ...
      q =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = I(z, n);
              e && delete z[n], L(t, n, r), e && t !== z && L(z, n, e);
            }
          : L,
      $ = function(t) {
      ...
      Q = function(t) {
        ...
        return !(this === z && i(B, t) && !i(U, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, D) && this[D][t])) || n);
      },
      Z = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== z || !i(B, n) || i(U, n))) {
          var r = I(t, n);
          return !r || !i(B, n) || (i(t, D) && t[D][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === z, e = N(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(z, n)) || o.push(B[n]);
        return o;
      };
    V ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === z && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), q(this, t, E(1, r));
            };
      ...
      (r(45).f = Q),
      (M.f = nt),
      u && !r(30) && a(z, 'propertyIsEnumerable', Q, !0),
      (y.f = function(t) {
        return $(v(t));
      })),
      ...
      (t.runOptimizerTest = function() {
        var t = (function() {
          var t,
            r =
              ((t = e().mark(function t() {
                var r, o, i, u, c, a, f, s, l, h, p, v, y, d, g;
                return e().wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (r = '../TestFiles/'), (o = 'newsletter'), (t.prev = 2), (t.next = 5), n.PDFDoc.createFromURL(r + o + '.pdf');
                        case 5:
                          return (i = t.sent).initSecurityHandler(), (t.next = 9), i.lock();
                        case 9:
                          return (t.next = 11), n.Optimizer.optimize(i);
                        case 11:
                          return (t.next = 13), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 13:
                          (u = t.sent), saveBufferAsPDFDoc(u, o + '_opt1.pdf'), (t.next = 20);
                          break;
                        case 17:
                          (t.prev = 17), (t.t0 = t.catch(2)), console.log(t.t0);
                        case 20:
                          return (t.prev = 20), (t.next = 23), n.PDFDoc.createFromURL(r + o + '.pdf');
                        case 23:
                          return (c = t.sent).initSecurityHandler(), (t.next = 27), c.lock();
                        case 27:
                          return (
                            (a = new n.Optimizer.ImageSettings()).setCompressionMode(n.Optimizer.ImageSettings.CompressionMode.e_jpeg),
                            a.setQuality(1),
                            a.setImageDPI(144, 96),
                            a.forceRecompression(!0),
                            (f = new n.Optimizer.OptimizerSettings()).setColorImageSettings(a),
                            f.setGrayscaleImageSettings(a),
                            (t.next = 37),
                            n.Optimizer.optimize(c, f)
                          );
                        case 37:
                          return (t.next = 39), c.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 39:
                          (s = t.sent), saveBufferAsPDFDoc(s, o + '_opt2.pdf'), (t.next = 46);
                          break;
                        case 43:
                          (t.prev = 43), (t.t1 = t.catch(20)), console.log(t.t1);
                        case 46:
                          return (t.prev = 46), (t.next = 49), n.PDFDoc.createFromURL(r + o + '.pdf');
                        case 49:
                          return (l = t.sent).initSecurityHandler(), (t.next = 53), l.lock();
                        case 53:
                          return (
                            (h = new n.Optimizer.MonoImageSettings()).setCompressionMode(n.Optimizer.MonoImageSettings.CompressionMode.e_jbig2),
                            h.forceRecompression(!0),
                            (p = new n.Optimizer.OptimizerSettings()).setMonoImageSettings(h),
                            (t.next = 60),
                            n.Optimizer.optimize(l, p)
                          );
                        case 60:
                          return (t.next = 62), l.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 62:
                          (v = t.sent), saveBufferAsPDFDoc(v, o + '_opt3.pdf'), (t.next = 69);
                          break;
                        case 66:
                        ...
                        case 72:
                          return (y = t.sent).initSecurityHandler(), (t.next = 76), y.lock();
                        case 76:
                          return (t.next = 78), n.Flattener.create();
                        case 78:
                          return (d = t.sent), (t.next = 81), d.process(y, n.Flattener.Mode.e_fast);
                        case 81:
                          return (t.next = 83), y.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 83:

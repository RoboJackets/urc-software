!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      xt || ((B.f = Gt), (G.f = Bt)),
        c(c.S + c.F * !xt, 'Object', { getOwnPropertyDescriptor: Gt, defineProperty: Bt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (I && (b = s(I.call(new t()))) !== Object.prototype && b.next && (f(b, S, !0), e || 'function' == typeof b[l] || u(b, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? F : w('values'), keys: d ? F : w('keys'), entries: M }), g)) for (x in m) x in O || i(O, x, m[x]);
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          x(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        x(t);
      ...
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== V || !i(B, n) || i(U, n))) {
          var r = A(t, n);
          return !r || !i(B, n) || (i(t, D) && t[D][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? U : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), q(this, t, E(1, r));
            };
        ...
        var n = t.Core.PDFNet,
          r = (function() {
            var r,
              i =
                ((r = e().mark(function r() {
                  var o, i, u, c, a, f, s, l, h, p, v, y, d, g, m;
                  return e().wrap(
                    function(r) {
                      for (;;)
                        switch ((r.prev = r.next)) {
                          case 0:
                            return (r.prev = 0), (o = '../TestFiles/'), (r.next = 4), n.PDFDoc.create();
                          case 4:
                            return (i = r.sent).initSecurityHandler(), i.lock(), (r.next = 9), n.ElementBuilder.create();
                          case 9:
                            return (u = r.sent), (r.next = 12), n.ElementWriter.create();
                          case 12:
                            return (c = r.sent), (r.next = 15), n.Rect.init(0, 0, 612, 794);
                          case 15:
                            return (a = r.sent), (r.next = 18), i.pageCreate(a);
                          case 18:
                            return (f = r.sent), c.beginOnPage(f, n.ElementWriter.WriteMode.e_overlay), (r.next = 22), n.Image.createFromURL(i, o + 'peppers.jpg');
                          case 22:
                            return (s = r.sent), (r.next = 25), n.Matrix2D.create(200, 0, 0, 250, 50, 500);
                          case 25:
                            return (l = r.sent), (r.next = 28), n.Matrix2D.createZeroMatrix();
                          case 28:
                            return (h = r.sent), (r.next = 31), h.set(200, 0, 0, 250, 50, 500);
                          case 31:
                            return (r.next = 33), u.createImageFromMatrix(s, h);
                          case 33:
                            return (p = r.sent), c.writePlacedElement(p), (r.next = 37), n.Image.createFromURL(i, o + 'butterfly.png');
                          case 37:
                            return (s = r.sent), (r.t0 = n.Matrix2D), (r.next = 41), s.getImageWidth();
                          case 41:
                            return (r.t1 = r.sent), (r.next = 44), s.getImageHeight();
                          case 44:
                            return (r.t2 = r.sent), (r.next = 47), r.t0.create.call(r.t0, r.t1, 0, 0, r.t2, 300, 500);
                          case 47:
                            return (l = r.sent), (r.next = 50), u.createImageFromMatrix(s, l);
                          case 50:
                            return (p = r.sent), c.writePlacedElement(p), (r.next = 54), n.Image.createFromURL(i, o + 'pdfnet.gif');
                          case 54:
                            return (s = r.sent), (r.t3 = n.Matrix2D), (r.next = 58), s.getImageWidth();
                          case 58:
                            return (r.t4 = r.sent), (r.next = 61), s.getImageHeight();
                          case 61:
                            return (r.t5 = r.sent), (r.next = 64), r.t3.create.call(r.t3, r.t4, 0, 0, r.t5, 50, 350);
                          case 64:
                            return (l = r.sent), (r.next = 67), u.createImageFromMatrix(s, l);
                          case 67:
                            return (p = r.sent), c.writePlacedElement(p), (r.next = 71), n.Image.createFromURL(i, o + 'grayscale.tif');
                          case 71:
                            return (s = r.sent), (r.t6 = n.Matrix2D), (r.next = 75), s.getImageWidth();
                          case 75:
                            return (r.t7 = r.sent), (r.next = 78), s.getImageHeight();
                          case 78:
                            return (r.t8 = r.sent), (r.next = 81), r.t6.create.call(r.t6, r.t7, 0, 0, r.t8, 10, 50);
                          case 81:
                            return (l = r.sent), (r.next = 84), u.createImageFromMatrix(s, l);
                          case 84:
                            return (p = r.sent), c.writePlacedElement(p), c.end(), i.pagePushBack(f), (r.next = 90), i.pageCreate(a);
                          case 90:
                            return (f = r.sent), c.beginOnPage(f, 1, !0, !0), (r.next = 94), n.ObjSet.create();
                          case 94:
                            return (v = r.sent), (r.next = 97), v.createArray();
                          case 97:
                            return (y = r.sent), (r.next = 100), y.pushBackName('JBIG2');
                          case 100:
                            return (r.next = 102), y.pushBackName('Lossy');
                          case 102:
                            return (r.next = 104), n.Image.createFromURL(i, o + 'multipage.tif', y);
                          case 104:
                            return (s = r.sent), (r.next = 107), n.Matrix2D.create(612, 0, 0, 794, 0, 0);
                          case 107:
                            return (l = r.sent), (r.next = 110), u.createImageFromMatrix(s, l);
                          case 110:
                            return (p = r.sent), c.writePlacedElement(p), c.end(), i.pagePushBack(f), (r.next = 116), i.pageCreate(a);
                          case 116:
                            return (f = r.sent), c.beginOnPage(f, 1, !0, !0), (r.next = 120), n.Image.createFromURL(i, o + 'palm.jp2');
                          case 120:
                            return (s = r.sent), (r.t9 = n.Matrix2D), (r.next = 124), s.getImageWidth();
                          case 124:
                            return (r.t10 = r.sent), (r.next = 127), s.getImageHeight();
                          case 127:
                            return (r.t11 = r.sent), (r.next = 130), r.t9.create.call(r.t9, r.t10, 0, 0, r.t11, 96, 80);
                          case 130:
                            return (l = r.sent), (r.next = 133), u.createImageFromMatrix(s, l);
                          case 133:
                            return (p = r.sent), c.writePlacedElement(p), (r.next = 137), n.Font.create(i, n.Font.StandardType1Font.e_times_roman);
                          case 137:
                            return (d = r.sent), (r.t12 = c), (r.next = 141), u.createTextBeginWithFont(d, 32);
                          case 141:
                            return (r.t13 = r.sent), r.t12.writeElement.call(r.t12, r.t13), (r.next = 145), u.createTextRun('JPEG2000 Sample', d, 32);
                          case 145:
                            return (p = r.sent), (r.next = 148), n.Matrix2D.create(1, 0, 0, 1, 190, 30);
                          case 148:
                            return (l = r.sent), p.setTextMatrix(l), c.writeElement(p), (r.next = 153), u.createTextEnd();
                          case 153:
                            return (g = r.sent), c.writeElement(g), c.end(), i.pagePushBack(f), (r.next = 159), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 159:
                            (m = r.sent), t.saveBufferAsPDFDoc(m, 'addimage.pdf'), console.log('Done. Result saved in addimage.pdf...'), (r.next = 167);
                            break;
                          case 164:

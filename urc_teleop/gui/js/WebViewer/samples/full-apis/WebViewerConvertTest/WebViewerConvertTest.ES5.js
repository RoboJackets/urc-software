                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 6:
                            return (o = t.sent).initSecurityHandler(), o.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 12), o.convertToXod();
                          case 12:
                            return (i = t.sent), saveBufferAsXOD(i, 'from_pdf.xod'), (t.next = 16), o.convertToXodStream();
                          case 16:
                            return (u = t.sent), (t.next = 19), n.FilterReader.create(u);
                          case 19:
                            (c = t.sent), (f = []), (s = a = 1024);
                          case 23:
                            if (a !== s) {
                            ...
                            return (t.next = 26), c.read(a);
                          case 26:
                            (l = t.sent), (s = l.length), f.push(l), (t.next = 23);
                            break;
                          case 31:
                            for (h = new Uint8Array(f.length * a + s), p = 0; p < f.length; p++) (v = p * a), (y = f[p]), h.set(y, v);
                            saveBufferAsXOD(h, 'from_pdf_streamed.xod'), console.log('done.'), (t.next = 41);
                            break;
                          case 37:

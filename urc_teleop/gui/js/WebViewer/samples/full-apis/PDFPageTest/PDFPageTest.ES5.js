!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Nt = function() {
          return vt.apply(kt ? ht.call(Ft(this)) : Ft(this), arguments);
        },
        Tt = {
      ...
      v(Ut, Ct),
        p(Ut, yt, Ct.values),
        v(Ut, { slice: Dt, set: Rt, constructor: function() {}, toString: pt, toLocaleString: Nt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Pt(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? O : S('values'), keys: d ? O : S('keys'), entries: M }), g)) for (b in m) b in P || i(P, b, m[b]);
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(j) instanceof n && 0 !== F.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      L = function(t) {
        var n;
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, R) || L(t, R, E(1, {})), (t[R][n] = !0)), q(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(G, t) && !i(U, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, R) && this[R][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(G, n) || i(U, n))) {
          var r = I(t, n);
          return !r || !i(G, n) || (i(t, R) && t[R][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = k(w(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == R || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = k(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(V, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (a(
        (N = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, R) && i(this[R], t) && (this[R][t] = !1), q(this, t, E(1, r));
            };
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      N.prototype[C] || r(14)(N.prototype, C, N.prototype.valueOf),
      h(N, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = f(s(u(b.index), h.length), 0), F = [], O = 1; O < b.length; O++) F.push(void 0 === (x = b[O]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var j = [E].concat(F, P, h);
              void 0 !== M && j.push(M);
              var A = String(n.apply(void 0, j));
            } else A = y(E, h, P, F, M, n);
        ...
        var n = t.Core.PDFNet,
          r = (function() {
            var t,
              r =
                ((t = e().mark(function t() {
                  var r, o, i, u, c, a, f, s, l, h, p, v, y, d, g, m, b, x, S, w, _, E, P, F, O, M, j, A;
                  return e().wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return console.log('Beginning Test'), (r = '../TestFiles/'), (o = null), (t.prev = 3), (t.next = 6), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 6:
                            return (i = t.sent).initSecurityHandler(), i.lock(), console.log('PDF document initialized and locked'), (t.next = 12), i.getPageCount();
                          case 12:
                            (u = t.sent), (c = Math.min(4, u)), (o = []), (a = 1);
                          case 16:
                            if (!(a <= c)) {
                              t.next = 31;
                              break;
                          ...
                          case 19:
                            return (
                              (f = t.sent),
                              (s = 'newsletter_split_page_' + a + '.pdf'),
                              f.insertPages(0, i, a, a, n.PDFDoc.InsertFlag.e_none),
                              (o[a - 1] = f),
                              (t.next = 25),
                              f.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized)
                            );
                          case 25:
                            (l = t.sent), saveBufferAsPDFDoc(l, s), console.log('Result saved as ' + s);
                          case 28:
                            ++a, (t.next = 16);
                            break;
                          case 31:
                          ...
                          case 41:
                            (h = t.sent).initSecurityHandler(), h.lock(), console.log('Sample 2, merge several PDF documents into one:'), (p = 1);
                          case 46:
                            if (!(p <= o.length)) {
                              t.next = 55;
                              break;
                            }
                            return (v = o[p - 1]), (t.next = 50), v.getPageCount();
                          case 50:
                            (y = t.sent), h.insertPages(p, v, 1, y, n.PDFDoc.InsertFlag.e_none);
                          case 52:
                            ++p, (t.next = 46);
                            break;
                          case 55:
                            return (t.next = 57), h.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 57:
                            return (d = t.sent), saveBufferAsPDFDoc(d, 'newsletter_merged.pdf'), (t.next = 61), n.endDeallocateStack();
                          case 61:
                            t.next = 66;
                            break;
                          case 63:
                          ...
                          case 78:
                            ...
                            return (t.next = 81), g.getPageIterator(m);
                          case 81:
                            (b = t.sent), g.pageRemove(b), (m -= 2), (t.next = 78);
                            break;
                          case 86:
                            return (t.next = 88), g.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 88:
                            return (x = t.sent), saveBufferAsPDFDoc(x, 'newsletter_page_removed.pdf'), (t.next = 92), n.endDeallocateStack();
                          case 92:
                            t.next = 97;
                            break;
                          case 94:
                          ...
                          case 103:
                            return (S = t.sent).initSecurityHandler(), S.lock(), (t.next = 108), n.PDFDoc.createFromURL(r + 'fish.pdf');
                          case 108:
                            return (w = t.sent).initSecurityHandler(), w.lock(), (t.next = 113), w.getPageIterator(1);
                          case 113:
                            return (_ = t.sent), (t.next = 116), S.getPageIterator(1);
                          case 116:
                            (E = t.sent), (P = 1);
                          case 118:
                            return (t.next = 120), E.hasNext();
                          case 120:
                            if (!t.sent) {
                              t.next = 131;
                              break;
                            ...
                            return (t.t3 = S), (t.t4 = E), (t.next = 126), _.current();
                          case 126:
                          ...
                          case 128:
                            ...
                            break;
                          case 131:
                            return (t.next = 133), S.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 133:
                            return (F = t.sent), saveBufferAsPDFDoc(F, 'newsletter_page_insert.pdf'), console.log('done'), (t.next = 138), n.endDeallocateStack();
                          case 138:
                            t.next = 143;
                            break;
                          case 140:
                          ...
                          case 149:
                            return (O = t.sent).initSecurityHandler(), (t.next = 153), O.getPage(1);
                          case 153:
                            return (M = t.sent), (t.next = 156), O.getPageIterator(7);
                          case 156:
                            return (
                              (j = t.sent),
                              O.pageInsert(j, M),

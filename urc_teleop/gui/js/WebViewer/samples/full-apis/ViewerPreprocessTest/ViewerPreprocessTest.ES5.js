    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), X(t, n, r)) : L(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), X(this, t, E(1, r));
            };
          ...
          .then(function() {
            return (
              (t = (function() {
                var t = i(
                  e().mark(function t(n) {
                    var r, o, i, c, a, f, s, l, h, p, v, y, d, g, m;
                    return e().wrap(function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (r = '../../samples/full-apis/TestFiles/grayscale.tif'), (t.next = 3), u.startDeallocateStack();
                          case 3:
                            return console.log('Traversing all annotations in the document...'), (t.next = 6), u.ElementWriter.create();
                          case 6:
                            return (o = t.sent), (t.next = 9), u.ElementBuilder.create();
                          case 9:
                            return (i = t.sent), (t.next = 12), u.Image.createFromURL(n, r);
                          case 12:
                            return (c = t.sent), (t.next = 15), n.getPageIterator(1);
                          case 15:
                            (a = t.sent), (f = 0);
                          case 18:
                            return (t.next = 20), a.hasNext();
                          case 20:
                            if (!t.sent) {
                              t.next = 81;
                              break;
                            }
                            return (t.next = 23), a.current();
                          case 23:
                            return (s = t.sent), (t.next = 26), s.getNumAnnots();
                          case 26:
                            (l = t.sent), (h = 0);
                          case 28:
                            if (!(h < l)) {
                          ...
                          case 38:
                            (v = t.sent), (t.t0 = v), (t.next = t.t0 === u.Annot.Type.e_Stamp ? 42 : 73);
                            break;
                          case 42:
                            return o.begin(n), (t.next = 45), c.getImageWidth();
                          case 45:
                            return (y = t.sent), (t.next = 48), c.getImageHeight();
                          case 48:
                            return (d = t.sent), (t.next = 51), i.createImageScaled(c, 0, 0, y, d);
                          case 51:
                            return (g = t.sent), o.writePlacedElement(g), (t.next = 55), o.end();
                          case 55:
                            return (m = t.sent).putRect('BBox', 0, 0, y, d), m.putName('Subtype', 'Form'), m.putName('Type', 'XObject'), (t.next = 61), i.createFormFromStream(m);
                          case 61:
                            return (g = t.sent), o.writePlacedElement(g), (t.next = 65), o.end();
                          case 65:
                            return (m = t.sent).putRect('BBox', 0, 0, y, d), m.putName('Subtype', 'Form'), m.putName('Type', 'XObject'), (t.next = 71), p.setAppearance(m);
                          case 71:
                          ...
                          case 74:
                            ...
                            break;
                          case 77:
                            return (t.next = 79), a.next();
                          case 79:
                            t.next = 18;
                            break;
                          case 81:
                            return console.log('number of annotation modifications: ' + f), (t.next = 84), u.endDeallocateStack();
                          case 84:
                          case 'end':
                            return t.stop();
                        }
                          ...
                          switch ((n.prev = n.next)) {
                            case 0:
                              return (
                                (r = null),
                                (n.prev = 1),
                                (o = '../../samples/full-apis/TestFiles/fish_stamped.pdf'),
                                console.log('loading document from url: ' + o),
                                (n.next = 8),
                                u.PDFDoc.createFromURL(o)
                              );
                            case 8:
                              return (r = n.sent).initSecurityHandler(), r.lock(), console.log('loaded document from url: ' + o), (n.next = 14), t(r);
                            case 14:
                              return r.flattenAnnotations(), console.log('flattened document from url: ' + o), n.abrupt('return', r);
                            case 19:

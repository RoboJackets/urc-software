!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), S = r(c, v, 3), x = u(m.length), b = 0, w = e ? h(n, x) : a ? h(n, 0) : void 0; x > b; b++)
          if ((p || b in m) && ((d = S((y = m[b]), b, g)), t))
            if (e) w[b] = d;
            else if (d)
              switch (t) {
                case 3:
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Dt = {
          ...
          filter: function(t) {
            return At(this, X(Et(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          subarray: function(t, n) {
            var e = Et(this),
              r = e.length,
              o = m(t, r);
            return new (L(e, e[mt]))(e.buffer, e.byteOffset + o * e.BYTES_PER_ELEMENT, d((void 0 === n ? r : m(n, r)) - o));
          },
        },
        Rt = function(t, n) {
          return At(this, pt.call(Et(this), t, n));
        },
        Nt = function(t) {
          Et(this);
        ...
        zt = function(t, n) {
          return Bt(t, (n = S(n, !0))) ? p(2, t[n]) : G(t, n);
        },
        Ut = function(t, n, e) {
      ...
      v(Wt, Ct),
        h(Wt, yt, Ct.values),
        v(Wt, { slice: Rt, set: Nt, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        jt(Wt, 'buffer', 'b'),
        jt(Wt, 'byteOffset', 'o'),
        jt(Wt, 'byteLength', 'l'),
        jt(Wt, 'length', 'e'),
          ...
          S
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(e)) {
                  if (!(e instanceof $ || 'ArrayBuffer' == (a = b(e)) || 'SharedArrayBuffer' == a)) return xt in e ? Mt(v, e) : kt.call(v, e);
                  (i = e), (p = Pt(r, n));
                  var y = e.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, e) {
    ...
    ((n = t.exports = function(t, n, e, l, p) {
      ...
      if (i(g)) {
        for (h = c(t.length); h > S; S++) if ((d = n ? m(u((v = t[S]))[0], v[1]) : m(t[S])) === f || d === s) return d;
    ...
    t.exports = function(t, n, e, y, d, g) {
      ...
      if (
        ...
        O ||
          ...
          (b.constructor = S)),
          (E || A) && (_('delete'), _('has'), d && _('get')),
          (A || P) && _(x),
          g && b.clear && delete b.clear;
      } else (S = y.getConstructor(n, t, d, x)), u(S.prototype, e), (c.NEED = !0);
      return h(S, t), (w[t] = S), o(o.G + o.W + o.F * (S != m), w), g || y.setStrong(S, t, d), S;
    };
  },
  function(t, n, e) {
    for (
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, d, g) {
      ...
      var m,
        ...
        F = !1,
        P = t.prototype,
        E = P[l] || P['@@iterator'] || (y && P[y]),
        O = E || b(y),
        A = y ? (_ ? b('entries') : O) : void 0,
        M = ('Array' == n && P.entries) || E;
      if (
        ...
        if (((m = { values: _ ? O : b('values'), keys: d ? O : b('keys'), entries: A }), g)) for (S in m) S in P || i(P, S, m[S]);
  ...
  function(t, n, e) {
    ...
    function W(t, n, e, r, o, i) {
      ...
      for (var c = t[M]._b, a = u + t[k], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (m = function(t) {
        ...
        a(S.prototype, {
          ...
          setInt16: function(t, n) {
            W(this, 2, t, R, n, arguments[2]);
          },
          setUint16: function(t, n) {
            W(this, 2, t, R, n, arguments[2]);
          },
          setInt32: function(t, n) {
            W(this, 4, t, N, n, arguments[2]);
          },
    ...
    g(m, 'ArrayBuffer'), g(S, 'DataView'), c(S.prototype, u.VIEW, !0), (n.ArrayBuffer = m), (n.DataView = S);
  },
  function(t, n) {
    var e = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = e);
  ...
  function(t, n, e) {
    ...
    var r,
      ...
      k = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== E.indexOf('6.6') && -1 === b.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      I = function(t) {
        var n;
    ...
    k ||
      ...
      (i = function() {
        var t = new r();
        (this.promise = t), (this.resolve = f(C, t, 1)), (this.reject = f(N, t, 1));
      }),
      (S.f = j = function(t) {
    ...
    var o = e(1),
      ...
      J = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          S(e),
          i(U, n) ? (e.enumerable ? (i(t, N) && t[N][n] && (t[N][n] = !1), (e = P(e, { enumerable: F(0, !1) }))) : (i(t, N) || I(t, N, F(1, {})), (t[N][n] = !0)), q(t, n, e)) : I(t, n, e)
        );
      },
      X = function(t, n) {
        S(t);
      ...
      Z = function(t) {
        ...
        return !(this === G && i(U, t) && !i(W, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, N) && this[N][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== G || !i(U, n) || i(W, n))) {
          var e = k(t, n);
          return !e || !i(U, n) || (i(t, N) && t[N][n]) || (e.enumerable = !0), e;
        }
      },
      tt = function(t) {
        for (var n, e = L(w(t)), r = [], o = 0; e.length > o; ) i(U, (n = e[o++])) || n == N || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === G, r = L(e ? W : w(t)), o = [], u = 0; r.length > u; ) !i(U, (n = r[u++])) || (e && !i(G, n)) || o.push(U[n]);
        return o;
      };
    V ||
      (a(
        (T = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === G && n.call(W, e), i(this, N) && i(this[N], t) && (this[N][t] = !1), q(this, t, F(1, e));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, b = '', w = 0, _ = 0; _ < m.length; _++) {
            S = m[_];
            for (var F = String(S[0]), P = f(s(u(S.index), p.length), 0), E = [], O = 1; O < S.length; O++) E.push(void 0 === (x = S[O]) ? x : String(x));
            var A = S.groups;
            if (h) {
              var M = [F].concat(E, P, p);
              void 0 !== A && M.push(A);
              var j = String(n.apply(void 0, M));
            } else j = y(F, p, P, E, A, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, b = 0, w = []; b < p.length; ) {
              ...
              var _,
                F = a(m, v ? p : p.slice(b));
              if (null === F || (_ = l(c(m.lastIndex + (v ? 0 : b)), p.length)) === x) b = u(p, b, d);
              else {
  ...
  function(t, n, e) {
    ...
    var r,
      ...
      S = (t.exports = e(58)('WeakMap', g, m, f, !0, !0));
    p &&
      h &&
  ...
  function(t, n) {
    ...
    function r() {
      ...
      return (
        ...
        (t.mark = function(t) {
          return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : ((t.__proto__ = y), f(t, a, 'GeneratorFunction')), (t.prototype = Object.create(S)), t;
        }),
        (t.awrap = function(t) {
          return { __await: t };
        }),
        ...
        var n = t.Core.PDFNet,
          e = (function() {
            var t,
              e =
                ((t = r().mark(function t() {
                  var e, o, i, u, c, a, f, s, l, p, h, v, y, d, g, m, S, x, b, w, _, F, P, E, O, A, M, j, k, I, L, T, D, R, N, C, B, z, U, W, G, V, H, Y, q, $, K, J, X;
                  return r().wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (e = 0), (o = '../TestFiles/'), (t.prev = 2), (t.next = 5), n.startDeallocateStack();
                          case 5:
                            return (t.next = 7), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 7:
                            return (i = t.sent).initSecurityHandler(), i.lock(), (t.next = 12), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5);
                          case 12:
                            return (u = t.sent).setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_center, n.Stamper.VerticalAlignment.e_vertical_center), (t.next = 16), n.ColorPt.init(1, 0, 0);
                          case 16:
                            return (c = t.sent), u.setFontColor(c), (t.t0 = n.PageSet), (t.next = 21), i.getPageCount();
                          case 21:
                            return (t.t1 = t.sent), (t.next = 24), t.t0.createRange.call(t.t0, 1, t.t1);
                          case 24:
                            return (a = t.sent), u.stampText(i, 'If you are reading this\nthis is an even page', a), (t.t2 = n.PageSet), (t.next = 29), i.getPageCount();
                          case 29:
                            return (t.t3 = t.sent), (t.t4 = n.PageSet.Filter.e_odd), (t.next = 33), t.t2.createFilteredRange.call(t.t2, 1, t.t3, t.t4);
                          case 33:
                            return (f = t.sent), n.Stamper.deleteStamps(i, f), (t.next = 37), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 37:
                            return (s = t.sent), saveBufferAsPDFDoc(s, 'newsletter.ex1.pdf'), (t.next = 41), n.endDeallocateStack();
                          case 41:
                            t.next = 47;
                            break;
                          case 43:
                          ...
                          case 50:
                            return (t.next = 52), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 52:
                            return (l = t.sent).initSecurityHandler(), l.lock(), (t.next = 57), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5);
                          case 57:
                            return (p = t.sent), (t.next = 60), n.Image.createFromURL(l, o + 'peppers.jpg');
                          case 60:
                            return (
                              (h = t.sent),
                              p.setSize(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5),
                              p.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_left, n.Stamper.VerticalAlignment.e_vertical_center),
                              (t.next = 65),
                              n.ColorPt.init(0, 0, 0, 0)
                            );
                          case 65:
                            return (v = t.sent), p.setFontColor(v), p.setRotation(180), p.setAsBackground(!1), (t.next = 71), n.PageSet.createRange(1, 2);
                          case 71:
                            return (y = t.sent), p.stampImage(l, h, y), (t.next = 75), l.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 75:
                            return (d = t.sent), saveBufferAsPDFDoc(d, 'newsletter.ex2.pdf'), (t.next = 79), n.endDeallocateStack();
                          case 79:
                            t.next = 85;
                            break;
                          case 81:
                          ...
                          case 88:
                            return (t.next = 90), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 90:
                            return (g = t.sent).initSecurityHandler(), g.lock(), (t.next = 95), n.PDFDoc.createFromURL(o + 'fish.pdf');
                          case 95:
                            return (m = t.sent).initSecurityHandler(), m.lock(), (t.next = 100), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5);
                          case 100:
                            return (S = t.sent), (t.next = 103), m.getPage(1);
                          case 103:
                            return (x = t.sent), (t.next = 106), x.getCropBox();
                          case 106:
                            return (b = t.sent), (t.t7 = S), (t.t8 = n.Stamper.SizeType.e_absolute_size), (t.next = 111), b.width();
                          case 111:
                            return (
                              (t.t9 = t.sent),
                              (t.t10 = 0.1 * t.t9),
                              ...
                              S.setOpacity(0.4),
                              S.setRotation(-67),
                              S.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_right, n.Stamper.VerticalAlignment.e_vertical_bottom),
                              (t.t12 = n.PageSet),
                              (t.next = 121),
                              g.getPageCount()
                            );
                          ...
                          case 124:
                            return (w = t.sent), S.stampPage(g, x, w), (t.next = 128), g.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 128:
                            return (_ = t.sent), saveBufferAsPDFDoc(_, 'newsletter.ex3.pdf'), (t.next = 132), n.endDeallocateStack();
                          case 132:
                            t.next = 138;
                            break;
                          case 134:
                          ...
                          case 141:
                            return (t.next = 143), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 143:
                            return (F = t.sent).initSecurityHandler(), F.lock(), (t.next = 148), n.Stamper.create(n.Stamper.SizeType.e_absolute_size, 20, 20);
                          case 148:
                            return (P = t.sent).setOpacity(1), P.setRotation(45), P.setAsBackground(!0), P.setPosition(30, 40), (t.next = 155), n.Image.createFromURL(F, o + 'peppers.jpg');
                          case 155:
                            return (E = t.sent), (t.next = 158), n.PageSet.createFilteredRange(1, 20, n.PageSet.Filter.e_odd);
                          case 158:
                            return (O = t.sent), P.stampImage(F, E, O), (t.next = 162), F.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 162:
                            return (A = t.sent), saveBufferAsPDFDoc(A, 'newsletter.ex4.pdf'), (t.next = 166), n.endDeallocateStack();
                          case 166:
                            t.next = 172;
                            break;
                          case 168:
                          ...
                          case 175:
                            return (t.next = 177), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 177:
                            return (M = t.sent).initSecurityHandler(), M.lock(), (t.next = 182), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.05, 0.05);
                          case 182:
                            return (
                              (j = t.sent).setOpacity(0.7),
                              j.setRotation(90),
                              j.setPosition(0, 0),
                              j.setSize(n.Stamper.SizeType.e_font_size, 80, -1),
                              j.setTextAlignment(n.Stamper.TextAlignment.e_align_center),
                              (t.next = 190),
                              n.PageSet.createFilteredRange(1, 20, n.PageSet.Filter.e_even)
                            );
                          case 190:
                            return (k = t.sent), j.stampText(M, 'Goodbye\nMoon', k), (t.next = 194), M.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 194:
                          ...
                          case 207:
                            return (t.next = 209), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 209:
                            return (L = t.sent).initSecurityHandler(), L.lock(), (t.next = 214), n.PDFDoc.createFromURL(o + 'fish.pdf');
                          case 214:
                            return (T = t.sent).initSecurityHandler(), T.lock(), (t.next = 219), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.3, 0.3);
                          case 219:
                            return (
                              (D = t.sent).setOpacity(1),
                              D.setRotation(270),
                              D.setAsBackground(!0),
                              D.setPosition(0.5, 0.5, !0),
                              D.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_left, n.Stamper.VerticalAlignment.e_vertical_bottom),
                              (t.next = 227),
                              T.getPage(1)
                            );
                          case 227:
                            return (R = t.sent), (t.t17 = n.PageSet), (t.next = 231), L.getPageCount();
                          case 231:
                            return (t.t18 = t.sent), (t.t19 = n.PageSet.Filter.e_even), (t.next = 235), t.t17.createFilteredRange.call(t.t17, 1, t.t18, t.t19);
                          case 235:
                            return (N = t.sent), D.stampPage(L, R, N), (t.next = 239), L.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 239:
                            return (C = t.sent), saveBufferAsPDFDoc(C, 'newsletter.ex6.pdf'), (t.next = 243), n.endDeallocateStack();
                          case 243:
                            t.next = 249;
                            break;
                          case 245:
                          ...
                          case 252:
                            return (t.next = 254), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 254:
                            return (B = t.sent).initSecurityHandler(), B.lock(), (t.next = 259), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.1, 0.1);
                          case 259:
                            return (
                              (z = t.sent).setOpacity(0.8),
                              z.setRotation(135),
                              z.setAsBackground(!1),
                              z.showsOnPrint(!1),
                              z.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_left, n.Stamper.VerticalAlignment.e_vertical_top),
                              z.setPosition(10, 10),
                              (t.next = 268),
                              n.Image.createFromURL(B, o + 'peppers.jpg')
                            );
                          case 268:
                            return (U = t.sent), (t.t21 = n.PageSet), (t.next = 272), B.getPageCount();
                          case 272:
                            return (t.t22 = t.sent), (t.t23 = n.PageSet.Filter.e_all), (t.next = 276), t.t21.createFilteredRange.call(t.t21, 1, t.t22, t.t23);
                          case 276:
                            return (W = t.sent), z.stampImage(B, U, W), (t.next = 280), B.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 280:
                            return (G = t.sent), saveBufferAsPDFDoc(G, 'newsletter.ex7.pdf'), (t.next = 284), n.endDeallocateStack();
                          case 284:
                            t.next = 290;
                            break;
                          case 286:
                          ...
                          case 293:
                            return (t.next = 295), n.PDFDoc.createFromURL(o + 'newsletter.pdf');
                          case 295:
                            return (V = t.sent).initSecurityHandler(), V.lock(), (t.next = 300), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.07, -0.1);
                          case 300:
                            return (
                              (H = t.sent).setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_right, n.Stamper.VerticalAlignment.e_vertical_bottom),
                              H.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_center, n.Stamper.VerticalAlignment.e_vertical_top),
                              (t.next = 305),
                              n.Font.create(V, n.Font.StandardType1Font.e_courier)
                            );
                          case 305:
                            return (Y = t.sent), H.setFont(Y), (t.next = 309), n.ColorPt.init(1, 0, 0, 0);
                          case 309:
                            return (q = t.sent), H.setFontColor(q), H.setTextAlignment(n.Stamper.TextAlignment.e_align_right), H.setAsBackground(!0), (t.next = 315), n.PageSet.createRange(1, 2);
                          case 315:
                            return ($ = t.sent), H.stampText(V, 'This is a title!', $), (t.next = 319), n.Image.createFromURL(V, o + 'peppers.jpg');
                          case 319:
                            return (K = t.sent), H.setAsBackground(!1), (t.next = 323), n.PageSet.createRange(1, 1);
                          case 323:
                            return (J = t.sent), H.stampImage(V, K, J), (t.next = 327), V.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 327:
                            return (X = t.sent), saveBufferAsPDFDoc(X, 'newsletter.ex8.pdf'), (t.next = 331), n.endDeallocateStack();
                          case 331:
                            t.next = 337;
                            break;
                          case 333:

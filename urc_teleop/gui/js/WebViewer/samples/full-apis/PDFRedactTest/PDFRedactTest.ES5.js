!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Dt),
        p(Ut, yt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 4:
                            return (r = t.sent).initSecurityHandler(), r.lock(), (o = []), (t.t0 = o), (t.t1 = n.Redactor), (t.next = 12), n.Rect.init(100, 100, 550, 600);
                          case 12:
                            return (t.t2 = t.sent), (t.next = 15), t.t1.redactionCreate.call(t.t1, 1, t.t2, !1, 'Top Secret');
                          case 15:
                            return (t.t3 = t.sent), t.t0.push.call(t.t0, t.t3), (t.t4 = o), (t.t5 = n.Redactor), (t.next = 21), n.Rect.init(30, 30, 450, 450);
                          case 21:
                            return (t.t6 = t.sent), (t.next = 24), t.t5.redactionCreate.call(t.t5, 2, t.t6, !0, 'Negative Redaction');
                          case 24:
                            return (t.t7 = t.sent), t.t4.push.call(t.t4, t.t7), (t.t8 = o), (t.t9 = n.Redactor), (t.next = 30), n.Rect.init(0, 0, 100, 100);
                          case 30:
                            return (t.t10 = t.sent), (t.next = 33), t.t9.redactionCreate.call(t.t9, 2, t.t10, !1, 'Positive');
                          case 33:
                            return (t.t11 = t.sent), t.t8.push.call(t.t8, t.t11), (t.t12 = o), (t.t13 = n.Redactor), (t.next = 39), n.Rect.init(100, 100, 200, 200);
                          case 39:
                            return (t.t14 = t.sent), (t.next = 42), t.t13.redactionCreate.call(t.t13, 2, t.t14, !1, 'Positive');
                          case 42:
                            return (t.t15 = t.sent), t.t12.push.call(t.t12, t.t15), (t.t16 = o), (t.t17 = n.Redactor), (t.next = 48), n.Rect.init(300, 300, 400, 400);
                          case 48:
                            return (t.t18 = t.sent), (t.next = 51), t.t17.redactionCreate.call(t.t17, 2, t.t18, !1, '');
                          case 51:
                            return (t.t19 = t.sent), t.t16.push.call(t.t16, t.t19), (t.t20 = o), (t.t21 = n.Redactor), (t.next = 57), n.Rect.init(500, 500, 600, 600);
                          case 57:
                            return (t.t22 = t.sent), (t.next = 60), t.t21.redactionCreate.call(t.t21, 2, t.t22, !1, '');
                          case 60:
                            return (t.t23 = t.sent), t.t20.push.call(t.t20, t.t23), (t.t24 = o), (t.t25 = n.Redactor), (t.next = 66), n.Rect.init(0, 0, 700, 20);
                          case 66:
                          ...
                          case 73:
                            return (i = t.sent), (t.next = 76), n.Font.create(r, n.Font.StandardType1Font.e_times_roman);
                          case 76:
                            return (
                              (u = t.sent),
                              (c = { redaction_overlay: !0, positive_overlay_color: i, border: !1, font: u, show_redacted_content_regions: !0 }),
                              n.Redactor.redact(r, o, c, !1, !1),
                              (t.next = 81),
                              r.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized)
                            );
                          case 81:
                            (a = t.sent), saveBufferAsPDFDoc(a, 'redacted.pdf'), console.log('Done...'), (t.next = 89);
                            break;
                          case 86:

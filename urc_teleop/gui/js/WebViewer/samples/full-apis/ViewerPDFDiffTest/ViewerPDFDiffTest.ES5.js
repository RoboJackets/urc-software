          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            switch ((t.prev = t.next)) {
              case 0:
                (r = n.Core.PDFNet),
                  (o = null),
                  (u = null),
                  (a = window.parent.window.document),
                  (f = [null, null]),
                  (s = (function() {
                    var t = c(
                      i().mark(function t() {
                        ...
                        return i().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (n = new u.Color(200, 0, 0, 1)), (e = new u.Color(0, 200, 200, 1)), (t.next = 4), r.createDiffOptions();
                              case 4:
                                return (o = t.sent).setColorA(n), o.setColorB(e), o.setBlendMode(5), t.abrupt('return', o);
                              case 9:
                              case 'end':
                                return t.stop();
                            }
                        ...
                        return i().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 2:
                                return (u = t.sent).lock(), (t.next = 6), s();
                              case 6:
                                return (a = t.sent), (f = []), (t.next = 10), n.getPageIterator(1);
                              case 10:
                                return (l = t.sent), (t.next = 13), o.getPageIterator(1);
                              case 13:
                                (h = t.sent), (p = 0);
                              case 16:
                                return (t.next = 18), l.hasNext();
                              case 18:
                                if (!t.sent) {
                                  t.next = 27;
                                  break;
                                }
                                return (t.next = 21), l.current();
                              case 21:
                                (v = t.sent), (f[p] = [v]), p++;
                              case 24:
                                l.next(), (t.next = 16);
                              ...
                              case 27:
                                p = 0;
                              case 29:
                                return (t.next = 31), h.hasNext();
                              case 31:
                                if (!t.sent) {
                                  t.next = 40;
                                  break;
                                }
                                return (t.next = 34), h.current();
                              case 34:
                                (y = t.sent), (f[p] || (f[p] = [null])).push(y), p++;
                              case 37:
                                h.next(), (t.next = 29);
                                break;
                              case 40:
                                        ...
                                        i().mark(function t(n) {
                                          ...
                                          return i().wrap(function(t) {
                                            for (;;)
                                              switch ((t.prev = t.next)) {
                                                case 0:
                                                  return (o = e(n, 2)), (c = o[0]), (f = o[1]), c || (c = new r.Page(0)), f || (f = new r.Page(0)), (t.next = 5), u.appendVisualDiff(c, f, a);
                                                case 5:
                                                case 'end':
                                                  return t.stop();
                                              }
                      ...
                      i().mark(function t() {
                        ...
                        return i().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                if ((n = a.getElementById('compareButton')).classList.contains('disabled')) {
                                  t.next = 3;
                                  break;
                                }
                        ...
                        return i().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 5:
                                (f[r] = t.sent), null !== f[1] && null !== f[0] && h();
                              case 7:
                              case 'end':
                                return t.stop();
                            }
                  ...
                  a.getElementById('fileUpload1').addEventListener('change', function(t) {
                    p(t.target.files[0], 0);
                  }),
                  a.getElementById('fileUpload2').addEventListener('change', function(t) {
                      ...
                      i().mark(function t() {
                        return i().wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (o = window.Core), (u = window.Core.Annotations), o.enableFullPDF(), (t.next = 5), r.initialize();
                              case 5:
                              case 'end':
                                return t.stop();
                            }
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), v();
                              case 2:
                                return (t.next = 4), r.PDFDoc.createFromURL('../../samples/files/test_doc_1.pdf');
                              case 4:
                                return (n = t.sent), (t.next = 7), r.PDFDoc.createFromURL('../../samples/files/test_doc_2.pdf');
                              case 7:
                                return (e = t.sent), (t.next = 10), l(n, e);
                              case 10:
                                (a.getElementById('fileUpload1').disabled = !1), (a.getElementById('fileUpload2').disabled = !1);
                              case 12:
                              case 'end':
                                return t.stop();
                            }

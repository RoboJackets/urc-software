!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Dt),
        p(Ut, yt, Dt.values),
        v(Ut, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : S('values'), keys: d ? F : S('keys'), entries: j }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
    ...
    !(function(t) {
      t.runElementEditTest = function() {
              ...
              return e().wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 4:
                      return (c = t.sent), (t.next = 7), n.ColorPt.init(1, 0, 0, 0);
                    case 7:
                      return (a = t.sent), (t.next = 10), n.ColorPt.init(0, 0, 1, 0);
                    case 10:
                      return (f = t.sent), (t.next = 13), o.next();
                    case 13:
                      s = t.sent;
                    case 14:
                      if (null === s) {
                    ...
                    case 25:
                      return (t.next = 27), s.getGState();
                    case 27:
                      return (h = t.sent).setFillColorSpace(c), h.setFillColorWithColorPt(a), i.writeElement(s), t.abrupt('break', 60);
                    case 32:
                      return (t.next = 34), s.getGState();
                    case 34:
                      return (h = t.sent).setFillColorSpace(c), h.setFillColorWithColorPt(f), i.writeElement(s), t.abrupt('break', 60);
                    case 39:
                      return i.writeElement(s), (t.next = 42), s.getXObject();
                    case 42:
                      if (((p = t.sent), (v = p.getObjNum()), -1 !== u.indexOf(v))) {
                        t.next = 58;
                        break;
                      }
                      return (t.next = 47), p.getObjNum();
                    case 47:
                      return (y = t.sent), u.includes(y) || u.push(y), (t.next = 51), n.ElementWriter.create();
                    case 51:
                      return (d = t.sent), o.formBegin(), d.beginOnObj(p, !0), (t.next = 56), r(o, d, u);
                    case 56:
                      d.end(), o.end();
                    case 58:
                      return t.abrupt('break', 60);
        ...
        var u = (function() {
          var t = i(
            e().mark(function t() {
              var o, i, u, c, a, f, s, l, h, p, v, y;
              return e().wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return console.log('Beginning Test'), (o = 0), '../TestFiles/', (t.next = 5), n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf');
                    case 5:
                      return (i = t.sent).initSecurityHandler(), i.lock(), console.log('PDF document initialized and locked'), (t.next = 11), n.ElementWriter.create();
                    case 11:
                      return (u = t.sent), (t.next = 14), n.ElementReader.create();
                    case 14:
                      return (c = t.sent), (a = []), (t.next = 18), i.getPageCount();
                    case 18:
                      return (f = t.sent), (t.next = 21), i.getPageIterator(1);
                    case 21:
                      s = t.sent;
                    case 23:
                      return (t.next = 25), s.hasNext();
                    case 25:
                      if (!t.sent) {
                        t.next = 49;
                        break;
                      }
                      return (t.next = 28), s.current();
                    case 28:
                      return (l = t.sent), (t.next = 31), l.getIndex();
                    case 31:
                      return (h = t.sent), console.log('Processing elements on page ' + h + '/' + f), (t.next = 35), l.getSDFObj();
                    case 35:
                      return (p = t.sent), (t.next = 38), p.getObjNum();
                    case 38:
                      return (v = t.sent), a.includes(v) || a.push(v), c.beginOnPage(l), u.beginOnPage(l, n.ElementWriter.WriteMode.e_replacement, !1), (t.next = 44), r(c, u, a);
                    case 44:
                      u.end(), c.end();
                    case 46:
                      s.next(), (t.next = 23);
                      break;
                    case 49:
                      return (t.next = 51), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                    case 51:
                      return (y = t.sent), saveBufferAsPDFDoc(y, 'newsletter_edited.pdf'), console.log('Done.'), t.abrupt('return', o);
                    case 55:
                    case 'end':
                      return t.stop();
                  }

!(function(t) {
      ...
      a = function t(n, e, a) {
        ...
        for (f in (v && (a = e), a))
          (l = ((s = !p && g && void 0 !== g[f]) ? g : a)[f]),
            (h = d && s ? c(l, r) : y && 'function' == typeof l ? c(Function.call, l) : l),
            g && u(g, f, l, n & t.U),
            m[f] != l && i(m, f, h),
            y && x[f] != l && (x[f] = l);
      };
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), x = r(c, v, 3), b = u(m.length), S = 0, w = e ? p(n, b) : a ? p(n, 0) : void 0; b > S; S++)
          if ((h || S in m) && ((d = x((y = m[S]), S, g)), t))
            if (e) w[S] = d;
            else if (d)
              switch (t) {
                case 3:
  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Bt = function(t, n) {
          return Gt(t, (n = x(n, !0))) ? h(2, t[n]) : U(t, n);
        },
        Wt = function(t, n, e) {
          return !(Gt(t, (n = x(n, !0))) && w(e) && b(e, 'value')) || b(e, 'get') || b(e, 'set') || e.configurable || (b(e, 'writable') && !e.writable) || (b(e, 'enumerable') && !e.enumerable)
            ? V(t, n, e)
            : ((t[n] = e.value), t);
        };
      xt || ((W.f = Bt), (B.f = Wt)),
      ...
      v(Vt, Dt),
        p(Vt, yt, Dt.values),
        v(Vt, { slice: Ct, set: Rt, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        At(Vt, 'buffer', 'b'),
        At(Vt, 'byteOffset', 'o'),
        At(Vt, 'byteLength', 'l'),
        At(Vt, 'length', 'e'),
          ...
          x
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(e)) {
                  if (!(e instanceof K || 'ArrayBuffer' == (a = S(e)) || 'SharedArrayBuffer' == a)) return bt in e ? jt(v, e) : It.call(v, e);
                  (i = e), (h = Ot(r, n));
                  var y = e.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, y, d, g) {
      ...
      return p(x, t), (w[t] = x), o(o.G + o.W + o.F * (x != m), w), g || y.setStrong(x, t, d), x;
    };
  },
  function(t, n, e) {
    for (
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, d, g) {
      ...
      if (
        (j && (b = s(j.call(new t()))) !== Object.prototype && b.next && (f(b, w, !0), r || 'function' == typeof b[l] || u(b, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? F : S('values'), keys: d ? F : S('keys'), entries: M }), g)) for (x in m) x in O || i(O, x, m[x]);
      ...
      e(2)(function() {
        ...
        ? function(t, n) {
            for (var e = c(t), f = arguments.length, s = 1, l = i.f, h = u.f; f > s; )
              for (var p, v = a(arguments[s++]), y = l ? o(v).concat(l(v)) : o(v), d = y.length, g = 0; d > g; ) (p = y[g++]), (r && !h.call(v, p)) || (e[p] = v[p]);
            return e;
          }
        : f;
  },
    ...
    var o = e(1),
      ...
      J = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          x(e),
          i(W, n) ? (e.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (e = O(e, { enumerable: E(0, !1) }))) : (i(t, R) || N(t, R, E(1, {})), (t[R][n] = !0)), H(t, n, e)) : N(t, n, e)
        );
      },
      X = function(t, n) {
        x(t);
      ...
      Z = function(t) {
        ...
        return !(this === U && i(W, t) && !i(V, t)) && (!(n || !i(this, t) || !i(W, t) || (i(this, R) && this[R][t])) || n);
      },
      Q = function(t, n) {
      ...
      tt = function(t) {
        for (var n, e = L(w(t)), r = [], o = 0; e.length > o; ) i(W, (n = e[o++])) || n == R || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === U, r = L(e ? V : w(t)), o = [], u = 0; r.length > u; ) !i(W, (n = r[u++])) || (e && !i(U, n)) || o.push(W[n]);
        return o;
      };
    z ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === U && n.call(V, e), i(this, R) && i(this[R], t) && (this[R][t] = !1), H(this, t, E(1, e));
            };
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            m = s(h);
          if ((d && (y = r(y, v > 2 ? arguments[2] : void 0, 2)), null == m || (p == Array && c(m)))) for (e = new p((n = a(h.length))); n > g; g++) f(e, g, d ? y(h[g], g) : h[g]);
          else for (l = m.call(h), e = new p(); !(o = l.next()).done; g++) f(e, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (e.length = g), e;
        },
      }
    );
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = a(m, v ? h : h.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : S)), h.length)) === b) S = u(h, S, d);
              else {
  ...
  function(t, n, e) {
    for (
      ...
      var d,
        ...
        x = u[g],
        b = x && x.prototype;
      if (b && (b[s] || c(b, s, h), b[l] || c(b, l, g), (a[g] = h), m)) for (d in r) b[d] || i(b, d, r[d], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
  ...
  function(t, n, e) {
    ...
    function o() {
      ...
      var g = Object.getPrototypeOf,
        m = g && g(g(P([])));
      m && m !== n && e.call(m, u) && (d = m);
      var x = (y.prototype = p.prototype = Object.create(d));
      function b(t) {
        ['next', 'throw', 'return'].forEach(function(n) {
          f(t, n, function(t) {
            return this._invoke(n, t);
      ...
      function w(t, n) {
        ...
        if (void 0 === e) {
          if (((n.delegate = null), 'throw' === n.method)) {
            if (t.iterator.return && ((n.method = 'return'), (n.arg = void 0), w(t, n), 'throw' === n.method)) return h;
            (n.method = 'throw'), (n.arg = new TypeError("The iterator does not provide a 'throw' method"));
          }
          return h;
        }
      ...
      return (
        ...
        (O.prototype = {
          ...
          delegateYield: function(t, n, e) {
            return (this.delegate = { iterator: P(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = void 0), h;
          },
        }),
        t
      );
      ...
      t.runPDFLayersTest = function() {
        var n = t.Core.PDFNet,
                ...
                return o().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 4:
                        return (i = t.sent), (t.next = 7), e.getOCGConfig();
                      case 7:
                        if (null != (u = t.sent)) {
                          t.next = 13;
                          break;
                      ...
                      case 11:
                        (u = t.sent).setName('Default');
                      case 13:
                        return (t.next = 15), u.getOrder();
                      case 15:
                        if (null != (c = t.sent)) {
                          t.next = 21;
                          break;
                      ...
                      case 19:
                        (c = t.sent), u.setOrder(c);
                      case 21:
                        return (t.next = 23), i.getSDFObj();
                      case 23:
                        return (a = t.sent), c.pushBack(a), (t.next = 27), n.endDeallocateStack();
                      case 27:
                ...
                return o().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 4:
                        return (i = t.sent).begin(e), (u = new n.Obj('0')), (t.next = 9), n.Image.createFromURL(e, '../TestFiles/peppers.jpg', u);
                      case 9:
                        return (c = t.sent), (t.next = 12), n.ElementBuilder.create();
                      case 12:
                        return (a = t.sent), (t.next = 15), c.getImageWidth();
                      case 15:
                        return (f = t.sent), (t.next = 18), c.getImageHeight();
                      case 18:
                        return (s = t.sent), (l = new n.Matrix2D(f / 2, -145, 20, s / 2, 200, 150)), (t.next = 22), a.createImageFromMatrix(c, l);
                      case 22:
                        return (h = t.sent), i.writePlacedElement(h), (t.next = 26), h.getGState();
                      case 26:
                        return t.sent.setTransform(200, 0, 0, 300, 50, 450), i.writePlacedElement(h), (t.t0 = i), (t.next = 32), a.createImageScaled(c, 300, 600, 200, -150);
                      case 32:
                        return (t.t1 = t.sent), t.t0.writePlacedElement.call(t.t0, t.t1), (t.next = 36), i.end();
                      case 36:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        return (t.next = 4), n.ElementWriter.create();
                      case 4:
                        return (i = t.sent).begin(e), (t.next = 8), n.ElementBuilder.create();
                      case 8:
                        return (
                          (u = t.sent).pathBegin(),
                          u.moveTo(306, 396),
                      ...
                      case 16:
                        return (c = t.sent).setPathFill(!0), (t.next = 20), c.getGState();
                      case 20:
                        return (a = t.sent), (t.next = 23), n.ColorSpace.createDeviceCMYK();
                      case 23:
                        return (f = t.sent), a.setFillColorSpace(f), (t.next = 27), n.ColorPt.init(1, 0, 0, 0);
                      case 27:
                        return (s = t.sent), a.setFillColorWithColorPt(s), c.setPathStroke(!0), (t.next = 32), n.ColorSpace.createDeviceRGB();
                      case 32:
                        return (l = t.sent), a.setStrokeColorSpace(l), (t.next = 36), n.ColorPt.init(1, 0, 0);
                      case 36:
                        return (h = t.sent), a.setStrokeColorWithColorPt(h), a.setLineWidth(20), a.setTransform(0.5, 0, 0, 0.5, 280, 300), i.writeElement(c), (t.next = 43), i.end();
                      case 43:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 4:
                        return (i = t.sent).begin(e), (t.next = 8), n.ElementBuilder.create();
                      case 8:
                        return (u = t.sent), (t.next = 11), n.Font.create(e, n.Font.StandardType1Font.e_times_roman);
                      case 11:
                        return (c = t.sent), (t.next = 14), u.createTextBeginWithFont(c, 120);
                      case 14:
                        return (a = t.sent), i.writeElement(a), (t.next = 18), u.createNewTextRun('A text layer!');
                      case 18:
                        return (a = t.sent), (t.next = 21), n.Matrix2D.createRotationMatrix(-0.785375);
                      case 21:
                        return (f = t.sent), (t.next = 24), f.concat(1, 0, 0, 1, 180, 100);
                      case 24:
                        return (t.next = 26), a.setTextMatrix(f);
                      case 26:
                        return (t.next = 28), i.writeElement(a);
                      case 28:
                        return (t.t0 = i), (t.next = 31), u.createTextEnd();
                      case 31:
                        return (t.t1 = t.sent), (t.next = 34), t.t0.writeElement.call(t.t0, t.t1);
                      case 34:
                        return (t.next = 36), i.end();
                      case 36:
                        return (s = t.sent).putName('Subtype', 'Form'), s.put('OC', r), s.putRect('BBox', 0, 0, 1e3, 1e3), (t.next = 42), n.endDeallocateStack();
                      case 42:
          ...
          a = (function() {
            var t = u(
              o().mark(function t() {
                var u, a, f, s, l, h, p, v, y, d, g, m, x, b, S, w, _, E, O, P, F, M, j, A, I;
                return o().wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return console.log('Beginning Test'), (u = null), (t.prev = 2), (t.next = 5), n.PDFDoc.create();
                        case 5:
                          return (u = t.sent).initSecurityHandler(), u.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 11), e(u, 'Image Layer');
                        case 11:
                          return (a = t.sent), (t.next = 14), e(u, 'Text Layer');
                        case 14:
                          return (f = t.sent), (t.next = 17), e(u, 'Vector Layer');
                        case 17:
                          return (s = t.sent), (t.next = 20), u.pageCreate();
                        case 20:
                          return (l = t.sent), (t.next = 23), n.ElementBuilder.create();
                        case 23:
                          return (h = t.sent), (t.next = 26), n.ElementWriter.create();
                        case 26:
                          return (p = t.sent).beginOnPage(l), (t.t0 = r), (t.t1 = u), (t.next = 32), a.getSDFObj();
                        case 32:
                          return (t.t2 = t.sent), (t.next = 35), (0, t.t0)(t.t1, t.t2);
                        case 35:
                          return (v = t.sent), (t.next = 38), h.createFormFromStream(v);
                        case 38:
                          return (y = t.sent), p.writeElement(y), (t.t3 = i), (t.t4 = u), (t.next = 44), s.getSDFObj();
                        case 44:
                          return (t.t5 = t.sent), (t.next = 47), (0, t.t3)(t.t4, t.t5);
                        case 47:
                          return (d = t.sent), (t.next = 50), h.createFormFromStream(d);
                        case 50:
                          (y = t.sent), p.writeElement(y), (t.next = 86);
                          break;
                        case 57:
                          return (t.t7 = t.sent), t.t6.pushBack.call(t.t6, t.t7), (t.t8 = g), (t.next = 62), s.getSDFObj();
                        case 62:
                          return (t.t9 = t.sent), t.t8.pushBack.call(t.t8, t.t9), (t.t10 = g), (t.next = 67), f.getSDFObj();
                        case 67:
                          return (t.t11 = t.sent), t.t10.PushBack.call(t.t10, t.t11), (t.next = 71), n.OCMD.create(u, g, n.OCMD.VisibilityPolicyType.e_AllOn);
                        case 71:
                          return (m = t.sent), (t.t12 = h), (t.t13 = c), (t.t14 = u), (t.next = 77), m.getSDFObj();
                        case 77:
                        ...
                        case 83:
                          ...
                          break;
                        case 86:
                          return (t.t17 = h), (t.t18 = c), (t.t19 = u), (t.next = 91), f.getSDFObj();
                        case 91:
                        ...
                        case 97:
                          y = t.sent;
                        case 98:
                          return p.writeElement(y), (t.t22 = h), (t.next = 102), l.getPageWidth();
                        case 102:
                          return (t.t23 = t.sent), (t.next = 105), l.getPageHeight();
                        case 105:
                          return (t.t24 = t.sent), (t.next = 108), t.t22.createRect.call(t.t22, 0, 0, t.t23, t.t24);
                        case 108:
                          return (y = t.sent).setPathFill(!1), y.setPathStroke(!0), (t.next = 113), y.getGState();
                        case 113:
                          return t.sent.setLineWidth(40), p.writeElement(y), p.end(), u.pagePushBack(l), (t.next = 120), u.getViewPrefs();
                        case 120:
                          return t.sent.setPageMode(n.PDFDocViewPrefs.PageMode.e_UseOC), (t.next = 124), u.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 124:
                        ...
                        case 132:
                          return (t.prev = 132), (t.next = 135), u.hasOC();
                        case 135:
                          if (t.sent) {
                            t.next = 139;
                            break;
                          ...
                          break;
                        case 139:
                          return (t.next = 141), u.getOCGConfig();
                        case 141:
                          return (b = t.sent), (t.next = 144), n.OCGContext.createFromConfig(b);
                        case 144:
                          return (S = t.sent), (t.next = 147), n.PDFDraw.create();
                        case 147:
                          return (w = t.sent).setImageSize(1e3, 1e3), w.setOCGContext(S), (t.next = 152), u.getPage(1);
                        case 152:
                          return (_ = t.sent), (t.next = 155), w.exportStream(_);
                        case 155:
                          return (E = t.sent), saveBufferAsPNG(E, 'pdf_layers_default.png'), S.setNonOCDrawing(!1), (t.next = 160), u.getOCGs();
                        case 160:
                          if (null === (O = t.sent)) {
                            t.next = 189;
                            break;
                        ...
                        case 166:
                          ...
                          return (t.t26 = n.OCG), (t.next = 170), O.getAt(P);
                        case 170:
                          return (t.t27 = t.sent), (t.next = 173), t.t26.createFromObj.call(t.t26, t.t27);
                        case 173:
                          return (M = t.sent), S.resetStates(!1), S.setState(M, !0), (j = 'pdf_layers_'), (t.t28 = j), (t.next = 180), M.getName();
                        case 180:
                          return (j = t.t28 += t.sent), (j += '.png'), (t.next = 184), w.exportStream(_);
                        case 184:
                          (A = t.sent), saveBufferAsPNG(A, j);
                        case 186:
                          ++P, (t.next = 166);
                          break;
                        case 189:
                          return S.setNonOCDrawing(!0), S.setOCDrawMode(n.OCGContext.OCDrawMode.e_NoOC), (t.next = 193), w.exportStream(_);
                        case 193:
                          (I = t.sent), saveBufferAsPNG(I, 'pdf_layers_non_oc.png');
                        case 195:

    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 3:
                        return (o = t.sent).initSecurityHandler(), o.lock(), (t.next = 8), o.getPageCount();
                      case 8:
                        return (i = t.sent), (t.next = 11), n.PDFDraw.create(100);
                      case 11:
                        return (u = t.sent), t.abrupt('return', { doc: o, pdfdraw: u, pagecount: i });
                      case 15:
        ...
        o = (function() {
          var t = i(
            e().mark(function t(r, o) {
              var i, u, c, a, f, s, l, h, p, v;
              return e().wrap(
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (t.prev = 0), (i = r.doc), (u = r.pdfdraw), (t.next = 5), i.getPage(o);
                      case 5:
                        return (c = t.sent), (t.next = 8), u.getBitmap(c, n.PDFDraw.PixelFormat.e_rgba, !1);
                      case 8:
                        return (
                          (a = t.sent),
                          (f = a.width),
                          (s = a.height),
                          (l = new Uint8ClampedArray(a.buf)),
                          ((h = document.createElement('canvas')).width = f),
                          (h.height = s),
                          (p = h.getContext('2d')),
                          (v = p.createImageData(f, s)).data.set(l),
                          p.putImageData(v, 0, 0),
                          t.abrupt('return', h)
                        );
                      case 22:

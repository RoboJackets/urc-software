    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : L(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
        ...
        var n = t.Core.PDFNet,
          r = (function() {
            var t,
              r =
                ((t = e().mark(function t() {
                  var r, o, i, u, c, a, f, s, l, h, p, v, y, d, g, m, b, x, S;
                  return e().wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (o = '../TestFiles/' + (r = 'newsletter.pdf')),
                              (t.next = 11),
                              n.PDFACompliance.createFromUrl(!1, o, '', n.PDFACompliance.Conformance.e_Level1B, void 0, 10, !1)
                            );
                          case 11:
                            return (i = t.sent), (t.next = 14), i.getErrorCount();
                          case 14:
                            if (0 !== (u = t.sent)) {
                              t.next = 19;
                              break;
                            ...
                            break;
                          case 19:
                            console.log(r + ' is NOT a valid PDFA.'), (c = 0);
                          case 21:
                            if (!(c < u)) {
                              t.next = 46;
                              break;
                            }
                            return (t.next = 24), i.getError(c);
                          case 24:
                            return (a = t.sent), (t.next = 27), n.PDFACompliance.getPDFAErrorMessage(a);
                          case 27:
                            return (f = t.sent), (t.next = 30), i.getRefObjCount(a);
                          case 30:
                            if (!((s = t.sent) > 0)) {
                              t.next = 43;
                              break;
                          ...
                          case 34:
                            ...
                            return (t.next = 37), i.getRefObj(a, h);
                          case 37:
                            (p = t.sent), l.push(p);
                          case 39:
                            h++, (t.next = 34);
                            break;
                          case 42:
                            console.log('Error:' + f + '. Objects:' + l.toString());
                          case 43:
                            c++, (t.next = 21);
                            break;
                          case 46:
                          ...
                          case 51:
                            return (
                              ...
                              (d = ''),
                              (g = 10),
                              (m = '../TestFiles/' + (v = 'fish.pdf')),
                              console.log('Converting input document: ' + v),
                              (t.next = 63),
                              n.PDFACompliance.createFromUrl(!0, m, d, n.PDFACompliance.Conformance.e_Level1B, void 0, g)
                            );
                          case 63:
                            return (b = t.sent), (t.next = 66), b.getErrorCount();
                          case 66:
                            return (
                              0 === t.sent ? console.log(v + ' is a valid PDFA.') : console.log(v + ' is NOT a valid PDFA.'),
                              console.log('Save and validate the converted document: ' + y),
                              (t.next = 72),
                              b.saveAsFromBuffer(!0)
                            );
                          case 72:
                            return (x = t.sent), saveBufferAsPDFDoc(x, y), (t.next = 77), n.PDFACompliance.createFromBuffer(!1, x, d, n.PDFACompliance.Conformance.e_Level1B, void 0, g);
                          case 77:
                            return (S = t.sent), (t.next = 80), S.getErrorCount();
                          case 80:
                            0 === t.sent ? console.log(y + ' is a valid PDFA.') : console.log(y + ' is NOT a valid PDFA.'), (t.next = 87);
                            break;
                          case 84:

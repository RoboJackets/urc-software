        ...
        var n = t.Core.PDFNet,
          r = (function() {
            var t,
              r =
                ((t = e().mark(function t() {
                  var r, o, i, u, c, f, a, s, l, h, p, v, y, d, g;
                  return e().wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 5:
                            return (o = t.sent), (t.next = 8), o.getSDFDoc();
                          case 8:
                            return (
                              (i = t.sent).initSecurityHandler(), i.lock(), console.log('Modifying into dictionary, adding custom properties, embedding a stream...'), (t.next = 14), i.getTrailer()
                            );
                          case 14:
                            return (u = t.sent), (t.next = 17), u.find('Info');
                          case 17:
                            return (c = t.sent), (t.next = 20), c.hasNext();
                          case 20:
                            if (!t.sent) {
                              t.next = 43;
                              break;
                            }
                            return (t.next = 23), c.value();
                          case 23:
                            return (f = t.sent).putString('Producer', 'PDFTron PDFNet'), (t.next = 27), f.find('Author');
                          case 27:
                            return (c = t.sent), (t.next = 30), c.hasNext();
                          case 30:
                            if (!t.sent) {
                              t.next = 40;
                              break;
                            }
                            return (t.next = 33), c.value();
                          case 33:
                            return (a = t.sent), (t.next = 36), a.getAsPDFText();
                          case 36:
                            (s = t.sent), f.putText('Author', s + ' - Modified'), (t.next = 41);
                            break;
                          case 40:
                            f.putString('Author', 'Me, myself, and I');
                          case 41:
                            t.next = 48;
                            break;
                          case 43:
                            return (t.next = 45), u.putDict('Info');
                          case 45:
                            (f = t.sent).putString('Producer', 'PDFTron PDFNet'), f.putString('Title', 'My document');
                          case 48:
                            return (t.next = 50), f.putDict('My Direct Dict');
                          case 50:
                            return (l = t.sent).putNumber('My Number', 100), l.putArray('My Array'), (t.next = 55), i.createIndirectArray();
                          case 55:
                            return (h = t.sent), f.put('My Indirect Array', h), (t.next = 59), u.get('Root');
                          case 59:
                            return (p = t.sent), (t.t0 = h), (t.next = 63), p.value();
                          case 63:
                            return (t.t1 = t.sent), t.t0.pushBack.call(t.t0, t.t1), (t.next = 67), n.Filter.createURLFilter(r + 'my_stream.txt');
                          case 67:
                            return (v = t.sent), (t.next = 70), n.FilterReader.create(v);
                          case 70:
                            return (y = t.sent), (t.next = 73), i.createIndirectStreamFromFilter(y);
                          case 73:
                            return (d = t.sent), h.pushBack(d), (t.next = 77), i.saveMemory(0, '%PDF-1.4');
                          case 77:

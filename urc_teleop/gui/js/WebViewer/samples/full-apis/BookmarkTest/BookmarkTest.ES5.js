!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), x = e(c, v, 3), b = u(m.length), w = 0, S = r ? p(n, b) : a ? p(n, 0) : void 0; b > w; w++)
          if ((h || w in m) && ((d = x((y = m[w]), w, g)), t))
            if (r) S[w] = d;
            else if (d)
              switch (t) {
                case 3:
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Tt = {
          ...
          filter: function(t) {
            return At(this, X(Ft(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          subarray: function(t, n) {
            var r = Ft(this),
              e = r.length,
              o = m(t, e);
            return new (I(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : m(n, e)) - o));
          },
        },
        Rt = function(t, n) {
        ...
        Wt = function(t, n, r) {
          return !(Bt(t, (n = x(n, !0))) && S(r) && b(r, 'value')) || b(r, 'get') || b(r, 'set') || r.configurable || (b(r, 'writable') && !r.writable) || (b(r, 'enumerable') && !r.enumerable)
            ? V(t, n, r)
            : ((t[n] = r.value), t);
        };
      xt || ((W.f = Gt), (G.f = Wt)),
        c(c.S + c.F * !xt, 'Object', { getOwnPropertyDescriptor: Gt, defineProperty: Wt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Vt, Ct),
        p(Vt, yt, Ct.values),
        v(Vt, { slice: Rt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        kt(Vt, 'buffer', 'b'),
        kt(Vt, 'byteOffset', 'o'),
        kt(Vt, 'byteLength', 'l'),
        kt(Vt, 'length', 'e'),
          ...
          x
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return bt in r ? Mt(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, y, d, g) {
      ...
      return p(x, t), (S[t] = x), o(o.G + o.W + o.F * (x != m), S), g || y.setStrong(x, t, d), x;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        P = F || w(y),
        A = y ? (_ ? w('entries') : P) : void 0,
        M = ('Array' == n && O.entries) || F;
      if (
        (M && (b = s(M.call(new t()))) !== Object.prototype && b.next && (f(b, S, !0), e || 'function' == typeof b[l] || u(b, l, p)),
        _ &&
          F &&
          'values' !== F.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? P : w('values'), keys: d ? P : w('keys'), entries: A }), g)) for (x in m) x in O || i(O, x, m[x]);
  ...
  function(t, n, r) {
    ...
    function W(t, n, r, e) {
      var o = p(+r);
      if (o + n > t[k]) throw w('Wrong index!');
      var i = t[M]._b,
        u = o + t[j],
        c = i.slice(u, u + n);
    ...
    function V(t, n, r, e, o, i) {
      var u = p(+r);
      if (u + n > t[k]) throw w('Wrong index!');
    ...
    if (u.ABV) {
      ...
      (m = function(t) {
        ...
        o && (G(m, 'byteLength', '_l'), G(x, 'buffer', '_b'), G(x, 'byteLength', '_l'), G(x, 'byteOffset', '_o')),
        a(x.prototype, {
          getInt8: function(t) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          x(r),
          i(W, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        x(t);
      ...
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== U || !i(W, n) || i(V, n))) {
          var r = j(t, n);
          return !r || !i(W, n) || (i(t, D) && t[D][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = I(S(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = I(r ? V : S(t)), o = [], u = 0; e.length > u; ) !i(W, (n = e[u++])) || (r && !i(U, n)) || o.push(W[n]);
        return o;
      };
    z ||
      (a(
        (L = function() {
          ...
          return u && K && q(U, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, w = '', S = 0, _ = 0; _ < m.length; _++) {
            x = m[_];
            for (var E = String(x[0]), O = f(s(u(x.index), h.length), 0), F = [], P = 1; P < x.length; P++) F.push(void 0 === (b = x[P]) ? b : String(b));
            var A = x.groups;
            if (p) {
              var M = [E].concat(F, O, h);
              void 0 !== A && M.push(A);
              var k = String(n.apply(void 0, M));
            } else k = y(E, h, O, F, A, n);
            O >= S && ((w += h.slice(S, O) + k), (S = O + E.length));
          }
          return w + h.slice(S);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, w = 0, S = []; w < h.length; ) {
              ...
              var _,
                E = a(m, v ? h : h.slice(w));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : w)), h.length)) === b) w = u(h, w, d);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        x = u[g],
        b = x && x.prototype;
      if (b && (b[s] || c(b, s, h), b[l] || c(b, l, g), (a[g] = h), m)) for (d in e) b[d] || i(b, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      t.runBookmarkTest = function() {
        var n = t.Core.PDFNet,
                ...
                return e().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        for (t.t0 = t.sent, o = t.t0 - 1, i = 0; i < o; ++i) r += '  ';
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        return (u = ''), (c = ''), (a = ''), (t.next = 6), r(i, u);
                      case 6:
                        return (u = t.sent), (t.next = 9), i.getTitle();
                      case 9:
                        return (a = t.sent), (t.t0 = u), (t.next = 13), i.isOpen();
                      case 13:
                      ...
                      case 18:
                        t.t2 = '+ ';
                      case 19:
                        return (t.t3 = t.t2), (t.t4 = a), (t.t5 = t.t3 + t.t4), (c = t.t5 + ' ACTION -> '), (t.next = 25), i.getAction();
                      case 25:
                        return (f = t.sent), (t.next = 28), f.isValid();
                      case 28:
                        if (!t.sent) {
                          t.next = 54;
                          break;
                        }
                        return (t.next = 31), f.getType();
                      case 31:
                        if (t.sent !== n.Action.Type.e_GoTo) {
                          t.next = 51;
                          break;
                        }
                        return (t.next = 35), f.getDest();
                      case 35:
                        return (s = t.sent), (t.next = 38), s.isValid();
                      case 38:
                        if (!t.sent) {
                          t.next = 49;
                          break;
                        }
                        return (t.next = 41), s.getPage();
                      case 41:
                        return (l = t.sent), (t.t6 = console), (t.t7 = c + 'GoTo Page # '), (t.next = 46), l.getIndex();
                      case 46:
                      ...
                      case 49:
                        ...
                        break;
                      case 51:
                        console.log(c + 'Not a "GoTo" action');
                      case 52:
                        t.next = 55;
                        break;
                      case 54:
                        console.log(c + 'NULL');
                      case 55:
                        return (t.next = 57), i.hasChildren();
                      case 57:
                        if (!t.sent) {
                          t.next = 64;
                          break;
                        }
                        return (t.t10 = o), (t.next = 61), i.getFirstChild();
                      case 61:
                        return (t.t11 = t.sent), (t.next = 64), (0, t.t10)(t.t11);
                      case 64:
                        return (t.next = 66), i.getNext();
                      case 66:
                        (i = t.sent), (t.next = 0);
                        break;
                      case 69:
          ...
          u = (function() {
            var t = i(
              e().mark(function t() {
                var r, i, u, c, a, f, s, l, h, p, v, y, d, g, m, x, b, w, S, _, E, O, F, P, A, M, k, j, N, I, L, T, R, D;
                return e().wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                      ...
                      case 4:
                        return (i = t.sent).initSecurityHandler(), i.lock(), (t.next = 9), n.Bookmark.create(i, 'Red');
                      case 9:
                        return (u = t.sent), (t.next = 12), n.Bookmark.create(i, 'Green');
                      case 12:
                        return (c = t.sent), (t.next = 15), n.Bookmark.create(i, 'Blue');
                      case 15:
                        return (a = t.sent), i.addRootBookmark(u), i.addRootBookmark(c), i.addRootBookmark(a), a.addNewNext('foo'), a.addNewNext('bar'), (t.next = 23), i.getPageIterator(1);
                      case 23:
                        return (f = t.sent), (t.next = 26), f.current();
                      case 26:
                        return (s = t.sent), (t.next = 29), i.getPage(1);
                      case 29:
                        return t.sent, (t.next = 32), n.Destination.createFit(s);
                      case 32:
                        return (l = t.sent), (t.t0 = u), (t.next = 36), n.Action.createGoto(l);
                      case 36:
                        return (t.t1 = t.sent), t.t0.setAction.call(t.t0, t.t1), (t.next = 40), i.getPage(10);
                      case 40:
                        return (h = t.sent), (t.next = 43), n.Destination.createFit(h);
                      case 43:
                        return (p = t.sent), (t.t2 = c), (t.next = 47), n.Action.createGoto(p);
                      case 47:
                        return (t.t3 = t.sent), t.t2.setAction.call(t.t2, t.t3), (v = 'blue1'), (t.next = 52), i.getPage(19);
                      case 52:
                        return (y = t.sent), (t.next = 55), n.Destination.createFit(y);
                      case 55:
                        return (d = t.sent), (t.next = 58), n.Action.createGotoWithKey(v, d);
                      case 58:
                        return (g = t.sent), a.setAction(g), (t.next = 62), u.addNewChild('Red - Page 1');
                      case 62:
                        return (m = t.sent), (t.t4 = m), (t.t5 = n.Action), (t.t6 = n.Destination), (t.next = 68), i.getPage(1);
                      case 68:
                        return (t.t7 = t.sent), (t.next = 71), t.t6.createFit.call(t.t6, t.t7);
                      case 71:
                        return (t.t8 = t.sent), (t.next = 74), t.t5.createGoto.call(t.t5, t.t8);
                      case 74:
                        return (t.t9 = t.sent), t.t4.setAction.call(t.t4, t.t9), (t.next = 78), u.addNewChild('Red - Page 2');
                      case 78:
                        return (x = t.sent), (t.t10 = x), (t.t11 = n.Action), (t.t12 = n.Destination), (t.next = 84), i.getPage(2);
                      case 84:
                      ...
                      case 90:
                        return (t.t15 = t.sent), t.t10.setAction.call(t.t10, t.t15), (t.next = 94), u.addNewChild('Red - Page 3');
                      case 94:
                        return (b = t.sent), (t.t16 = b), (t.t17 = n.Action), (t.t18 = n.Destination), (t.next = 100), i.getPage(3);
                      case 100:
                      ...
                      case 106:
                        return (t.t21 = t.sent), t.t16.setAction.call(t.t16, t.t21), (t.next = 110), b.addNewChild('Red - Page 4');
                      case 110:
                        return (w = t.sent), (t.t22 = w), (t.t23 = n.Action), (t.t24 = n.Destination), (t.next = 116), i.getPage(4);
                      case 116:
                      ...
                      case 122:
                        return (t.t27 = t.sent), t.t22.setAction.call(t.t22, t.t27), (t.next = 126), b.addNewChild('Red - Page 5');
                      case 126:
                        return (S = t.sent), (t.t28 = S), (t.t29 = n.Action), (t.t30 = n.Destination), (t.next = 132), i.getPage(5);
                      case 132:
                      ...
                      case 138:
                        return (t.t33 = t.sent), t.t28.setAction.call(t.t28, t.t33), (t.next = 142), b.addNewChild('Red - Page 6');
                      case 142:
                        return (_ = t.sent), (t.t34 = _), (t.t35 = n.Action), (t.t36 = n.Destination), (t.next = 148), i.getPage(6);
                      case 148:
                      ...
                      case 154:
                        return (t.t39 = t.sent), t.t34.setAction.call(t.t34, t.t39), (t.next = 158), i.getFirstBookmark();
                      case 158:
                        return (E = t.sent), (t.next = 161), E.find('foo');
                      case 161:
                        return (O = t.sent), (t.next = 164), O.isValid();
                      case 164:
                        if (!t.sent) {
                          t.next = 168;
                          break;
                      ...
                      case 179:
                        return u.setColor(1, 0, 0), c.setColor(0, 1, 0), c.setFlags(2), a.setColor(0, 0, 1), a.setFlags(3), (t.next = 186), i.saveMemoryBuffer(0);
                      case 186:
                      ...
                      case 191:
                        return (A = t.sent).initSecurityHandler(), A.lock(), (t.next = 196), A.getFirstBookmark();
                      case 196:
                        return (M = t.sent), (t.next = 199), o(M);
                      case 199:
                        return console.log('Done.'), (i = A).initSecurityHandler(), (t.next = 204), i.createIndirectDict();
                      case 204:
                        return (k = t.sent).putName('Type', 'Filespec'), k.putString('F', 'bookmark.pdf'), (t.next = 209), n.FileSpec.createFromObj(k);
                      case 209:
                        return (j = t.sent), (t.next = 212), n.Action.createGotoRemoteSetNewWindow(j, 5, !0);
                      case 212:
                        return (N = t.sent), (t.next = 215), n.Bookmark.create(i, 'REMOTE BOOKMARK 1');
                      case 215:
                        return (I = t.sent).setAction(N), i.addRootBookmark(I), (t.next = 220), n.Bookmark.create(i, 'REMOTE BOOKMARK 2');
                      case 220:
                        return (L = t.sent), i.addRootBookmark(L), (t.next = 224), L.getSDFObj();
                      case 224:
                        return (t.next = 226), t.sent.putDict('A');
                      case 226:
                        return (T = t.sent).putName('S', 'GoToR'), T.putBool('NewWindow', !0), T.put('F', k), (t.next = 232), T.putArray('D');
                      case 232:
                        return (R = t.sent).pushBackNumber(9), R.pushBackName('Fit'), (t.next = 237), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                      case 237:
                        return (D = t.sent), saveBufferAsPDFDoc(D, 'bookmark_remote.pdf'), console.log('Done. Result saved in bookmark_remote.pdf'), t.abrupt('return', r);
                      case 241:
                      case 'end':
                        return t.stop();
                    }

    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(B, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), q(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = f(s(u(b.index), h.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (p) {
        ...
        var n = t.Core.PDFNet,
          r = (function() {
            var t,
              r =
                ((t = e().mark(function t() {
                  var r, o, i, u, c, a, f, s, l, h, p, v, y, d, g, m, b, x, S, w, _, E, P, O, F;
                  return e().wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (t.next = 8),
                              n.PDFDoc.createFromURL(o + 'fish.pdf')
                            );
                          case 8:
                            return (
                          ...
                          case 17:
                            return (u = t.sent), (t.next = 20), u.get('Root');
                          case 20:
                            return (c = t.sent), (t.next = 23), c.value();
                          case 23:
                            return (a = t.sent), (t.next = 26), a.get('Pages');
                          case 26:
                            return (f = t.sent), (t.next = 29), f.value();
                          case 29:
                            return (s = t.sent), (t.next = 32), s.get('Kids');
                          case 32:
                            return (l = t.sent), (t.next = 35), l.value();
                          case 35:
                            return (h = t.sent), (t.next = 38), h.getAt(0);
                          case 38:
                            return (p = t.sent), (t.next = 41), n.Filter.createURLFilter(o + 'my_stream.txt');
                          case 41:
                            return (v = t.sent), (t.next = 44), n.FilterReader.create(v);
                          case 44:
                            return (y = t.sent), (d = new n.Filter('0')), (t.next = 48), n.Filter.createFlateEncode(d);
                          case 48:
                            return (g = t.sent), (t.next = 51), i.createIndirectStreamFromFilter(y, g);
                          case 51:
                            return (m = t.sent), (t.next = 54), p.put('Contents', m);
                          case 54:
                            return (t.next = 56), n.SecurityHandler.createDefault();
                          case 56:
                            return (
                              (b = t.sent).changeUserPasswordUString('test'),
                              console.log("Setting password to 'test'"),
                              b.setPermission(n.SecurityHandler.Permission.e_print, !1),
                              b.setPermission(n.SecurityHandler.Permission.e_extract_content, !0),
                              i.setSecurityHandler(b),
                              console.log('Saving modified file...'),
                              (t.next = 65),
                              i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized)
                            );
                          case 65:
                            (x = t.sent), saveBufferAsPDFDoc(x, 'secured.pdf'), (t.next = 74);
                            break;
                          case 69:
                            (t.prev = 69), (t.t0 = t.catch(4)), console.log(t.t0), console.log(t.t0.stack), (r = 1);
                          case 74:
                            return (t.prev = 74), console.log('Running Sample 2'), (S = i), (t.next = 79), S.initSecurityHandler();
                          case 79:
                            if (t.sent) {
                              t.next = 103;
                              break;
                            }
                            (w = !1), console.log("The password has been set to : 'test'"), (_ = ['password', 'testy', 'test']), (E = 0);
                          case 84:
                            if (!(E < _.length)) {
                              t.next = 99;
                              break;
                            }
                            return (P = _[E]), console.log("Trying password candidate: '" + P + "'"), (t.next = 89), S.initStdSecurityHandlerUString(P);
                          case 89:
                            if (!t.sent) {
                              t.next = 95;
                              break;
                            }
                            return (w = !0), console.log('The password is correct'), t.abrupt('break', 99);
                          case 95:
                          ...
                          case 103:
                            return S.lock(), console.log('PDF document initialized and locked'), (t.next = 107), S.getSecurityHandler();
                          case 107:
                            return (O = t.sent), (t.t1 = console), (t.next = 111), O.isUserPasswordRequired();
                          case 111:
                            return (t.t2 = t.sent), (t.t3 = 'Document Open Password: ' + t.t2), t.t1.log.call(t.t1, t.t3), (t.t4 = console), (t.next = 117), O.isMasterPasswordRequired();
                          case 117:
                            return (
                              (t.t5 = t.sent),
                              ...
                              (t.t7 = console),
                              (t.next = 124),
                              O.getPermission(n.SecurityHandler.Permission.e_owner)
                            );
                          case 124:
                            return (
                              (t.t8 = t.sent),
                              ...
                              (t.t10 = console),
                              (t.next = 130),
                              O.getPermission(n.SecurityHandler.Permission.e_doc_open)
                            );
                          case 130:
                            return (
                              (t.t11 = t.sent),
                              ...
                              (t.t13 = console),
                              (t.next = 136),
                              O.getPermission(n.SecurityHandler.Permission.e_extract_content)
                            );
                          case 136:
                            return (
                              (t.t14 = t.sent),
                              ...
                              (t.t16 = console),
                              (t.next = 142),
                              O.getPermission(n.SecurityHandler.Permission.e_doc_modify)
                            );
                          case 142:
                            return (
                              (t.t17 = t.sent),
                              ...
                              (t.t19 = console),
                              (t.next = 148),
                              O.getPermission(n.SecurityHandler.Permission.e_print)
                            );
                          case 148:
                            return (
                              (t.t20 = t.sent),
                              ...
                              (t.t22 = console),
                              (t.next = 154),
                              O.getPermission(n.SecurityHandler.Permission.e_print_high)
                            );
                          case 154:
                            return (
                              (t.t23 = t.sent),
                              ...
                              (t.t25 = console),
                              (t.next = 160),
                              O.getPermission(n.SecurityHandler.Permission.e_mod_annot)
                            );
                          case 160:
                            return (
                              (t.t26 = t.sent),
                              ...
                              (t.t28 = console),
                              (t.next = 166),
                              O.getPermission(n.SecurityHandler.Permission.e_fill_forms)
                            );
                          case 166:
                            return (
                              (t.t29 = t.sent),
                              ...
                              (t.t31 = console),
                              (t.next = 172),
                              O.getPermission(n.SecurityHandler.Permission.e_access_support)
                            );
                          case 172:
                            return (
                              (t.t32 = t.sent),
                              ...
                              (t.t34 = console),
                              (t.next = 178),
                              O.getPermission(n.SecurityHandler.Permission.e_assemble_doc)
                            );
                          case 178:
                            return (
                              (t.t35 = t.sent),
                              ...
                              S.removeSecurity(),
                              (t.next = 184),
                              S.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized)
                            );
                          case 184:
                            (F = t.sent), saveBufferAsPDFDoc(F, 'not_secured.pdf'), console.log('done'), (t.next = 193);
                            break;
                          case 189:

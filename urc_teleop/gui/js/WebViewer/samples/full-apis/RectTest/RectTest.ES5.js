                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 6:
                            return (o = t.sent).initSecurityHandler(), o.lock(), console.log('PDF document initialized and locked'), (t.next = 12), o.getPageIterator();
                          case 12:
                            return (i = t.sent), (t.next = 15), i.current();
                          case 15:
                            return (t.next = 17), t.sent.getMediaBox();
                          case 17:
                            return ((u = t.sent).x1 -= 200), (u.x2 -= 200), (t.next = 22), u.update();
                          case 22:
                            return (t.next = 24), o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 24:
                            (c = t.sent), saveBufferAsPDFDoc(c, 'tiger_shift.pdf'), console.log('Done.'), (t.next = 33);
                            break;
                          case 29:

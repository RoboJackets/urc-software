          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof J || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || L(t, D, E(1, {})), (t[D][n] = !0)), H(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), H(this, t, E(1, r));
            };
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.prev = 0), (r = '../TestFiles/'), (o = 'BusinessCard.pdf'), (t.next = 6), n.PDFDoc.createFromURL(r + 'BusinessCardTemplate.pdf');
                          case 6:
                            return (i = t.sent).initSecurityHandler(), i.lock(), (t.next = 11), n.ContentReplacer.create();
                          case 11:
                            return (u = t.sent), (t.next = 14), i.getPage(1);
                          case 14:
                            return (c = t.sent), (t.next = 17), n.Image.createFromURL(i, r + 'peppers.jpg');
                          case 17:
                            return (a = t.sent), (t.next = 20), c.getMediaBox();
                          case 20:
                            return (f = t.sent), (t.next = 23), a.getSDFObj();
                          case 23:
                            return (s = t.sent), (t.next = 26), u.addImage(f, s);
                          case 26:
                            return (t.next = 28), u.addString('NAME', 'John Smith');
                          case 28:
                            return (t.next = 30), u.addString('QUALIFICATIONS', 'Philosophy Doctor');
                          case 30:
                            return (t.next = 32), u.addString('JOB_TITLE', 'Software Developer');
                          case 32:
                            return (t.next = 34), u.addString('ADDRESS_LINE1', '#100 123 Software Rd');
                          case 34:
                            return (t.next = 36), u.addString('ADDRESS_LINE2', 'Vancouver, BC');
                          case 36:
                            return (t.next = 38), u.addString('PHONE_OFFICE', '604-730-8989');
                          case 38:
                            return (t.next = 40), u.addString('PHONE_MOBILE', '604-765-4321');
                          case 40:
                            return (t.next = 42), u.addString('EMAIL', 'info@pdftron.com');
                          case 42:
                            return (t.next = 44), u.addString('WEBSITE_URL', 'http://www.pdftron.com');
                          case 44:
                            return (t.next = 46), u.process(c);
                          case 46:
                            return (t.next = 48), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 48:
                            (l = t.sent), saveBufferAsPDFDoc(l, o), console.log('Done. Result saved in ' + o), (t.next = 56);
                            break;
                          case 53:
                            (t.prev = 53), (t.t0 = t.catch(0)), console.log(t.t0);
                          case 56:
                            return (t.prev = 56), (h = 'ContentReplaced.pdf'), (t.next = 62), n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf');
                          case 62:
                            return (p = t.sent).initSecurityHandler(), p.lock(), (t.next = 67), n.ContentReplacer.create();
                          case 67:
                            return (v = t.sent), (t.next = 70), p.getPage(1);
                          case 70:
                            return (y = t.sent), (t.next = 73), y.getMediaBox();
                          case 73:
                            return (d = t.sent), (t.next = 76), v.addText(d, 'The quick onyx goblin jumps over the lazy dwarf');
                          case 76:
                            return (t.next = 78), v.process(y);
                          case 78:
                            return (t.next = 80), p.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 80:
                            (g = t.sent), saveBufferAsPDFDoc(g, h), console.log('Done. Result saved in ' + h), console.log('Done.'), (t.next = 89);
                            break;
                          case 86:

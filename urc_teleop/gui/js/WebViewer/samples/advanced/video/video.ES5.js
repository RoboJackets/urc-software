!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return wt in r ? Mt(v, r) : Lt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              $(m !== Function.prototype ? P(d).concat(P(m)) : P(d), function(t) {
                t in v || p(v, t, d[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      if (
        (M && (w = s(M.call(new t()))) !== Object.prototype && w.next && (f(w, S, !0), e || 'function' == typeof w[l] || u(w, l, p)),
        _ &&
          F &&
          'values' !== F.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? P : x('values'), keys: y ? P : x('keys'), entries: A }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    var e,
      ...
      L = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== F.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var w, x = '', S = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), F = [], P = 1; P < b.length; P++) F.push(void 0 === (w = b[P]) ? w : String(w));
            var A = b.groups;
            if (p) {
            ...
            O >= S && ((x += h.slice(S, O) + j), (S = O + E.length));
          }
          return x + h.slice(S);
        },
      ];
                    ...
                    'https://pdftron.s3.amazonaws.com/downloads/pl/video/video.mp4',
                                      ...
                                      case 0:
                                        return (
                                          ...
                                          (r = i
                                            ...
                                            .getAllAnnotations()),
                                          (t.next = 4),
                                          s.exportAnnotations({ links: !1, widgets: !1, annotList: r })
                                        );
                                      case 4:
                      ...
                      i.addEventListener('pageComplete', function(t, n) {
                        if (!l) {
                          ...
                          E.addEventListener('scroll', _.debounce(F, 250));
                          var P,
                          ...
                          HyperList.create(E, {
                            ...
                            generate: function(t) {
                              ...
                              return n === c && (e.setAttribute('data-state', 'selected'), (P = e)), e;
                            },
                          }),
                            h.appendChild(E),
                            x.addEventListener(
                                      ...
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          e.getVideo().updateAnnotationsToTime(x.currentTime),
                                            P && P.removeAttribute('data-state'),
                                            (n = f.getFrameFromTime(x.currentTime)),
                                            (P = c.document.getElementById('frame'.concat(n))) && P.setAttribute('data-state', 'selected');
                                        case 5:
                                        case 'end':
                                          return t.stop();
                                      }
                          ...
                          g.addEventListener('click', function(t) {
                            ...
                            g.addEventListener('mousemove', function(t) {
                              ...
                              (j = r), w.setAttribute('data-state', 'visible'), (w.style = 'left: '.concat(t.offsetX, 'px;')), (w.innerHTML = ''.concat(f.getFormattedTime(r)));
                            }),

!(function(t) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || T(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : T(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/demo.pdf', enableFilePicker: !0 }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t),
        t.UI.enableFeatures([t.UI.Feature.ContentEdit]),
        t.UI.setToolbarGroup(t.UI.ToolbarGroup.EDIT_TEXT),

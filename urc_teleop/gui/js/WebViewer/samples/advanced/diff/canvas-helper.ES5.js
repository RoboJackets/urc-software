      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < b.length; _++) {
            ...
            } else A = y(O, h, E, P, F, n);
            E >= w && ((S += h.slice(w, E) + A), (w = E + O.length));
          }
          return S + h.slice(w);
        },
      ];
        ...
        combinePixels: function(a, s, l, h, p, v) {
          ...
          for (var O = 0; O < x.length; O += r) {
            var E = ((g = O), (b = a.width), (m = void 0), { x: (m = Math.floor(g / r)) % b, y: Math.floor(m / b) }),
              ...
              M = f(x, O),
              F = f(S, P),
              j = { r: M[n.R], g: M[n.G], b: M[n.B], a: M[n.A] };
            if (o(F[n.R], F[n.G], F[n.B], F[n.A]) && o(M[n.R], M[n.G], M[n.B], M[n.A])) j = e(e({}, j), {}, { a: 0 });
            else if (
              v &&
              ((y = { r: F[n.R], g: F[n.G], b: F[n.B], a: F[n.A] }), (d = { r: M[n.R], g: M[n.G], b: M[n.B], a: M[n.A] }), y && d && y.r === d.r && y.g === d.g && y.b === d.b && y.a === d.a)
            ) {
              var A = u([M[n.R], M[n.G], M[n.B]]) / 2;
              j = e(e({}, j), {}, { r: Math.ceil(127.5) + A, g: Math.ceil(127.5) + A, b: Math.ceil(127.5) + A });
            } else if (E.y <= s.height && E.x <= s.width)
              if (o(F[n.R], F[n.G], F[n.B], F[n.A])) {
                var I = Math.round(255 * h),
                  R = u([M[n.R], M[n.G], M[n.B]]);
                j = { r: v ? R : M[n.R], g: v ? R : M[n.G], b: v ? 255 : M[n.B], a: I };
              } else if (o(M[n.R], M[n.G], M[n.B], M[n.A])) {
                var N = Math.round(255 * l),
                  T = u([F[n.R], F[n.G], F[n.B]]);
                j = { r: v ? 255 : F[n.R], g: v ? T : F[n.G], b: v ? T : F[n.B], a: N };
              } else j = this.handleDifferentPixelColor(F, M, v, h, l);
            c(_.data, O, j);
          }

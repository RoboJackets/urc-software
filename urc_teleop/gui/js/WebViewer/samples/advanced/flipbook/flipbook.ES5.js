!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (f = w(r)) || 'SharedArrayBuffer' == f)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (j && (x = s(j.call(new t()))) !== Object.prototype && x.next && (a(x, S, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || L(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
  ...
  function(t, n) {
    ...
    var i = document.getElementById('flipbook'),
      u = document.getElementById('loading-message');
    u.innerHTML = 'Preparing document...';
    var c = { l: window.sampleL },
      f = new Core.DocumentViewer(),
      a = document.createElement('div');
    f.setViewerElement(a),
      f.setScrollViewElement(a),
      f.enableAnnotations(),
      f.addEventListener('annotationsLoaded', function() {
        var t = f.getDocument(),
          n = f.getAnnotationManager(),
          r = t.getPageInfo(1),
          c = r.width,
          a = r.height,
          s = t.getPageCount(),
          ...
          v = p.height,
          y = p.width;
        ((v * c) / a) * 2 < y ? (y = ((v * c) / a) * 2) : (v = ((y / c) * a) / 2);
        for (
          var d = function(r) {
              l.push(
                new Promise(function(i) {
                  var c = r + 1;
                  return t.requirePage(c).then(function() {
                    return t.loadCanvas({
                      pageNumber: c,
                      drawComplete:
                        ((r = e().mark(function t(r, o) {
                          return e().wrap(function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                case 0:
                                  return h.push({ index: o, canvas: r }), (u.innerHTML = 'Loading page canvas... ('.concat(h.length, '/').concat(s, ')')), (t.next = 4), n.drawAnnotations(o, r);
                                case 4:
                                  i();
                                case 5:
                                case 'end':
        ...
        Promise.all(l).then(function() {
          i.removeChild(u),
            (i.style.margin = '60px 0px 0px auto'),
            h
              .sort(function(t, n) {
                return t.index - n.index;
              })
              .forEach(function(t) {
                return i.appendChild(t.canvas);
              }),
            $('#flipbook').turn({ width: y, height: v }),
            setTimeout(function() {
              $('#flipbook').turn('next');
            }, 500),
      ...
      f.loadDocument('https://pdftron.s3.amazonaws.com/downloads/pl/Cheetahs.pdf', c);
  },
]);

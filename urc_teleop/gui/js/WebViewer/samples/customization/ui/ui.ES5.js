!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Gt, Ct),
        p(Gt, yt, Ct.values),
        v(Gt, { slice: kt, set: Bt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        At(Gt, 'buffer', 'b'),
        At(Gt, 'byteOffset', 'o'),
        At(Gt, 'byteLength', 'l'),
        At(Gt, 'length', 'e'),
    ...
    z ||
      (f(
        (L = function() {
          ...
          return u && H && q(V, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
        ...
        s = function() {
          r(function(t) {
            var n = t.getItems(),
              r =
                (function(t) {
                  for (var n = 0; n < t.length; ++n) if ('divider' === t[n].type) return n;
                })(n) + 1,
              e = n.slice(r);
            e.reverse(), t.update([].concat(n.slice(0, r), e));
          });
        },
        l = function(t, n) {
      ...
      NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach),
        ...
        document.getElementsByName('theme').forEach(function(t) {
          t.onchange = function(t) {
            'light' === t.target.id && t.target.checked ? c(a.LIGHT) : c(a.DARK);
          };
        });
    });
  },

...
def generate_launch_description():
    ...
    xacro_file = os.path.join(get_package_share_directory('urc_gazebo'
                              ), urdf_path)
    ...
    spawn_robot = Node(package='gazebo_ros',
                       executable='spawn_entity.py', arguments=[
        '-entity',
        'wallii',
        '-x',
        '0',
    ...
    gorilla_grip = ExecuteProcess(cmd=[
        'ros2',
        'control',
        'load_controller',
        '--set-state',
    ...
    return LaunchDescription([RegisterEventHandler(event_handler=OnProcessExit(target_action=spawn_robot,
                             ...
                             robot_state_publisher, spawn_robot])

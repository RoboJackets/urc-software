...
def generate_launch_description():
    ...
    servo_yaml = load_yaml("urc_arm_moveit_config", "config/panda_simulated_config.yaml")
    servo_params = {"urc_arm_moveit_config": servo_yaml}

    # RViz
    rviz_config_file = (
        get_package_share_directory("urc_arm_moveit_config") + "/config/moveit.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",

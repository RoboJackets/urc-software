...
void CovariancesOnGps::handleGps(const sensor_msgs::msg::NavSatFix::SharedPtr msg)
{
  ...
  output.position_covariance[0] = 4.0;  // x variance (m^2)
  output.position_covariance[4] = 4.0;  // y variance (m^2)
  output.position_covariance[8] = 9.0;  // z variance (m^2), or keep larger

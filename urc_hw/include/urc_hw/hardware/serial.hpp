...
#define SERIAL_SERIAL_FRAME_MAX_SIZE 100
...
{
  uint8_t data[SERIAL_SERIAL_FRAME_MAX_SIZE];
  size_t length;
};
...
private:
  ...
  uint8_t rx_frame_buffer_[SERIAL_SERIAL_FRAME_MAX_SIZE];
  size_t rx_frame_length_;
  uint16_t rx_frame_crc_;
  bool rx_frame_escape_;
  uint8_t tx_frame_buffer_[SERIAL_SERIAL_FRAME_MAX_SIZE];

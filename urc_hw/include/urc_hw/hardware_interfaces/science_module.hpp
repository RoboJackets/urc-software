#ifndef URC_HW__SCIENCE_MODULE_HW_INTERFACE_HPP
#define URC_HW__SCIENCE_MODULE_HW_INTERFACE_HPP
...
class ScienceModule : public hardware_interface::SystemInterface
{
public:
  ScienceModule();
  ~ScienceModule();
...
private:
  ...
  // nanopb
  uint8_t buffer[ScienceModuleCommand_size];
  size_t message_length;
};

}  // namespace urc_hardware::hardware_interfaces

#endif  // URC_HW__SCIENCE_MODULE_HW_INTERFACE_HPP

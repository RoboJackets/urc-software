...
std::vector<hardware_interface::StateInterface> IMU::export_state_interfaces()
{
  ...
  state_interfaces.emplace_back(info_.sensors[0].name, "quaternion.w", &this->quaternions[0]);
  state_interfaces.emplace_back(info_.sensors[0].name, "quaternion.x", &this->quaternions[1]);
  state_interfaces.emplace_back(info_.sensors[0].name, "quaternion.y", &this->quaternions[2]);
  state_interfaces.emplace_back(info_.sensors[0].name, "quaternion.z", &this->quaternions[3]);

...
IMUBroadcaster::IMUBroadcaster() : imu_state_publisher_(nullptr){};
...
controller_interface::return_type IMUBroadcaster::update(const rclcpp::Time& time, const rclcpp::Duration&)
{
  ...
  imu_message.linear_acceleration.x = state_interfaces_map_["linear_acceleration.x"]->get().get_value();
  imu_message.linear_acceleration.y = state_interfaces_map_["linear_acceleration.y"]->get().get_value();
  imu_message.linear_acceleration.z = state_interfaces_map_["linear_acceleration.z"]->get().get_value();
